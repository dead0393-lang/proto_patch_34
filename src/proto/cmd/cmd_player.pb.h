...
enum GetPlayerTokenReq_CmdId {
  ...
  GetPlayerTokenReq_CmdId_CMD_ID = 172,
...
enum GetPlayerTokenRsp_CmdId {
  ...
  GetPlayerTokenRsp_CmdId_CMD_ID = 198,
...
enum PlayerLoginReq_CmdId {
  ...
  PlayerLoginReq_CmdId_CMD_ID = 112,
...
enum PlayerLoginRsp_CmdId {
  ...
  PlayerLoginRsp_CmdId_CMD_ID = 135,
...
enum PlayerLogoutReq_CmdId {
  ...
  PlayerLogoutReq_CmdId_CMD_ID = 107,
...
enum PlayerLogoutRsp_CmdId {
  ...
  PlayerLogoutRsp_CmdId_CMD_ID = 121,
...
enum PlayerLogoutNotify_CmdId {
  ...
  PlayerLogoutNotify_CmdId_CMD_ID = 103,
...
enum PlayerDataNotify_CmdId {
  ...
  PlayerDataNotify_CmdId_CMD_ID = 190,
...
enum ChangeGameTimeReq_CmdId {
  ...
  ChangeGameTimeReq_CmdId_CMD_ID = 173,
...
enum ChangeGameTimeRsp_CmdId {
  ...
  ChangeGameTimeRsp_CmdId_CMD_ID = 199,
...
enum PlayerGameTimeNotify_CmdId {
  ...
  PlayerGameTimeNotify_CmdId_CMD_ID = 131,
...
enum PlayerPropNotify_CmdId {
  ...
  PlayerPropNotify_CmdId_CMD_ID = 175,
...
enum ClientTriggerEventNotify_CmdId {
  ...
  ClientTriggerEventNotify_CmdId_CMD_ID = 148,
...
enum SetPlayerPropReq_CmdId {
  ...
  SetPlayerPropReq_CmdId_CMD_ID = 197,
...
enum SetPlayerPropRsp_CmdId {
  ...
  SetPlayerPropRsp_CmdId_CMD_ID = 181,
...
enum SetPlayerBornDataReq_CmdId {
  ...
  SetPlayerBornDataReq_CmdId_CMD_ID = 105,
...
enum SetPlayerBornDataRsp_CmdId {
  ...
  SetPlayerBornDataRsp_CmdId_CMD_ID = 182,
...
enum DoSetPlayerBornDataNotify_CmdId {
  ...
  DoSetPlayerBornDataNotify_CmdId_CMD_ID = 147,
...
enum PlayerPropChangeNotify_CmdId {
  ...
  PlayerPropChangeNotify_CmdId_CMD_ID = 139,
...
enum SetPlayerNameReq_CmdId {
  ...
  SetPlayerNameReq_CmdId_CMD_ID = 153,
...
enum SetPlayerNameRsp_CmdId {
  ...
  SetPlayerNameRsp_CmdId_CMD_ID = 122,
...
enum SetOpenStateReq_CmdId {
  ...
  SetOpenStateReq_CmdId_CMD_ID = 165,
...
enum SetOpenStateRsp_CmdId {
  ...
  SetOpenStateRsp_CmdId_CMD_ID = 104,
...
enum OpenStateUpdateNotify_CmdId {
  ...
  OpenStateUpdateNotify_CmdId_CMD_ID = 193,
...
enum OpenStateChangeNotify_CmdId {
  ...
  OpenStateChangeNotify_CmdId_CMD_ID = 127,
...
enum PlayerCookReq_CmdId {
  ...
  PlayerCookReq_CmdId_CMD_ID = 194,
...
enum PlayerCookRsp_CmdId {
  ...
  PlayerCookRsp_CmdId_CMD_ID = 188,
...
enum PlayerRandomCookReq_CmdId {
  ...
  PlayerRandomCookReq_CmdId_CMD_ID = 126,
...
enum PlayerRandomCookRsp_CmdId {
  ...
  PlayerRandomCookRsp_CmdId_CMD_ID = 163,
...
enum CookDataNotify_CmdId {
  ...
  CookDataNotify_CmdId_CMD_ID = 195,
...
enum CookRecipeDataNotify_CmdId {
  ...
  CookRecipeDataNotify_CmdId_CMD_ID = 106,
...
enum CookGradeDataNotify_CmdId {
  ...
  CookGradeDataNotify_CmdId_CMD_ID = 134,
...
enum PlayerCompoundMaterialReq_CmdId {
  ...
  PlayerCompoundMaterialReq_CmdId_CMD_ID = 150,
...
enum PlayerCompoundMaterialRsp_CmdId {
  ...
  PlayerCompoundMaterialRsp_CmdId_CMD_ID = 143,
...
enum TakeCompoundOutputReq_CmdId {
  ...
  TakeCompoundOutputReq_CmdId_CMD_ID = 174,
...
enum TakeCompoundOutputRsp_CmdId {
  ...
  TakeCompoundOutputRsp_CmdId_CMD_ID = 176,
...
enum CompoundDataNotify_CmdId {
  ...
  CompoundDataNotify_CmdId_CMD_ID = 146,
...
enum GetCompoundDataReq_CmdId {
  ...
  GetCompoundDataReq_CmdId_CMD_ID = 141,
...
enum GetCompoundDataRsp_CmdId {
  ...
  GetCompoundDataRsp_CmdId_CMD_ID = 149,
...
enum PlayerTimeNotify_CmdId {
  ...
  PlayerTimeNotify_CmdId_CMD_ID = 191,
...
enum PlayerSetPauseReq_CmdId {
  ...
  PlayerSetPauseReq_CmdId_CMD_ID = 124,
...
enum PlayerSetPauseRsp_CmdId {
  ...
  PlayerSetPauseRsp_CmdId_CMD_ID = 156,
...
enum PlayerSetLanguageReq_CmdId {
  ...
  PlayerSetLanguageReq_CmdId_CMD_ID = 142,
...
enum PlayerSetLanguageRsp_CmdId {
  ...
  PlayerSetLanguageRsp_CmdId_CMD_ID = 130,
...
enum DataResVersionNotify_CmdId {
  ...
  DataResVersionNotify_CmdId_CMD_ID = 167,
...
enum DailyTaskDataNotify_CmdId {
  ...
  DailyTaskDataNotify_CmdId_CMD_ID = 158,
...
enum DailyTaskProgressNotify_CmdId {
  ...
  DailyTaskProgressNotify_CmdId_CMD_ID = 170,
...
enum DailyTaskScoreRewardNotify_CmdId {
  ...
  DailyTaskScoreRewardNotify_CmdId_CMD_ID = 117,
...
enum WorldOwnerDailyTaskNotify_CmdId {
  ...
  WorldOwnerDailyTaskNotify_CmdId_CMD_ID = 102,
...
enum AddRandTaskInfoNotify_CmdId {
  ...
  AddRandTaskInfoNotify_CmdId_CMD_ID = 119,
...
enum RemoveRandTaskInfoNotify_CmdId {
  ...
  RemoveRandTaskInfoNotify_CmdId_CMD_ID = 161,
...
enum TakePlayerLevelRewardReq_CmdId {
  ...
  TakePlayerLevelRewardReq_CmdId_CMD_ID = 129,
...
enum TakePlayerLevelRewardRsp_CmdId {
  ...
  TakePlayerLevelRewardRsp_CmdId_CMD_ID = 157,
...
enum PlayerLevelRewardUpdateNotify_CmdId {
  ...
  PlayerLevelRewardUpdateNotify_CmdId_CMD_ID = 200,
...
enum GivingRecordNotify_CmdId {
  ...
  GivingRecordNotify_CmdId_CMD_ID = 116,
...
enum GivingRecordChangeNotify_CmdId {
  ...
  GivingRecordChangeNotify_CmdId_CMD_ID = 187,
...
enum ItemGivingReq_CmdId {
  ...
  ItemGivingReq_CmdId_CMD_ID = 140,
...
enum ItemGivingRsp_CmdId {
  ...
  ItemGivingRsp_CmdId_CMD_ID = 118,
...
enum PlayerCookArgsReq_CmdId {
  ...
  PlayerCookArgsReq_CmdId_CMD_ID = 166,
...
enum PlayerCookArgsRsp_CmdId {
  ...
  PlayerCookArgsRsp_CmdId_CMD_ID = 168,
...
enum PlayerLuaShellNotify_CmdId {
  ...
  PlayerLuaShellNotify_CmdId_CMD_ID = 133,
...
enum ServerDisconnectClientNotify_CmdId {
  ...
  ServerDisconnectClientNotify_CmdId_CMD_ID = 184,
...
enum AntiAddictNotify_CmdId {
  AntiAddictNotify_CmdId_NONE = 0,
  AntiAddictNotify_CmdId_CMD_ID = 180,
  AntiAddictNotify_CmdId_ENET_CHANNEL_ID = 0,
  AntiAddictNotify_CmdId_ENET_IS_RELIABLE = 1,
  AntiAddictNotify_CmdId_AntiAddictNotify_CmdId_INT_MIN_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32min,
  AntiAddictNotify_CmdId_AntiAddictNotify_CmdId_INT_MAX_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32max
};
bool AntiAddictNotify_CmdId_IsValid(int value);
const AntiAddictNotify_CmdId AntiAddictNotify_CmdId_CmdId_MIN = AntiAddictNotify_CmdId_NONE;
const AntiAddictNotify_CmdId AntiAddictNotify_CmdId_CmdId_MAX = AntiAddictNotify_CmdId_CMD_ID;
const int AntiAddictNotify_CmdId_CmdId_ARRAYSIZE = AntiAddictNotify_CmdId_CmdId_MAX + 1;

const ::google::protobuf::EnumDescriptor* AntiAddictNotify_CmdId_descriptor();
inline const ::std::string& AntiAddictNotify_CmdId_Name(AntiAddictNotify_CmdId value) {
  return ::google::protobuf::internal::NameOfEnum(
    AntiAddictNotify_CmdId_descriptor(), value);
}
inline bool AntiAddictNotify_CmdId_Parse(
    const ::std::string& name, AntiAddictNotify_CmdId* value) {
  return ::google::protobuf::internal::ParseNamedEnum<AntiAddictNotify_CmdId>(
    AntiAddictNotify_CmdId_descriptor(), name, value);
}
enum PlayerForceExitReq_CmdId {
  PlayerForceExitReq_CmdId_NONE = 0,
  PlayerForceExitReq_CmdId_CMD_ID = 189,
  PlayerForceExitReq_CmdId_ENET_CHANNEL_ID = 0,
  PlayerForceExitReq_CmdId_ENET_IS_RELIABLE = 1,
  PlayerForceExitReq_CmdId_IS_ALLOW_CLIENT = 1,
  PlayerForceExitReq_CmdId_PlayerForceExitReq_CmdId_INT_MIN_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32min,
  PlayerForceExitReq_CmdId_PlayerForceExitReq_CmdId_INT_MAX_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32max
};
bool PlayerForceExitReq_CmdId_IsValid(int value);
const PlayerForceExitReq_CmdId PlayerForceExitReq_CmdId_CmdId_MIN = PlayerForceExitReq_CmdId_NONE;
const PlayerForceExitReq_CmdId PlayerForceExitReq_CmdId_CmdId_MAX = PlayerForceExitReq_CmdId_CMD_ID;
const int PlayerForceExitReq_CmdId_CmdId_ARRAYSIZE = PlayerForceExitReq_CmdId_CmdId_MAX + 1;

const ::google::protobuf::EnumDescriptor* PlayerForceExitReq_CmdId_descriptor();
inline const ::std::string& PlayerForceExitReq_CmdId_Name(PlayerForceExitReq_CmdId value) {
  return ::google::protobuf::internal::NameOfEnum(
    PlayerForceExitReq_CmdId_descriptor(), value);
}
inline bool PlayerForceExitReq_CmdId_Parse(
    const ::std::string& name, PlayerForceExitReq_CmdId* value) {
  return ::google::protobuf::internal::ParseNamedEnum<PlayerForceExitReq_CmdId>(
    PlayerForceExitReq_CmdId_descriptor(), name, value);
}
enum PlayerForceExitRsp_CmdId {
  PlayerForceExitRsp_CmdId_NONE = 0,
  PlayerForceExitRsp_CmdId_CMD_ID = 159,
  PlayerForceExitRsp_CmdId_ENET_CHANNEL_ID = 0,
  PlayerForceExitRsp_CmdId_ENET_IS_RELIABLE = 1,
  PlayerForceExitRsp_CmdId_PlayerForceExitRsp_CmdId_INT_MIN_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32min,
  PlayerForceExitRsp_CmdId_PlayerForceExitRsp_CmdId_INT_MAX_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32max
};
bool PlayerForceExitRsp_CmdId_IsValid(int value);
const PlayerForceExitRsp_CmdId PlayerForceExitRsp_CmdId_CmdId_MIN = PlayerForceExitRsp_CmdId_NONE;
const PlayerForceExitRsp_CmdId PlayerForceExitRsp_CmdId_CmdId_MAX = PlayerForceExitRsp_CmdId_CMD_ID;
const int PlayerForceExitRsp_CmdId_CmdId_ARRAYSIZE = PlayerForceExitRsp_CmdId_CmdId_MAX + 1;

const ::google::protobuf::EnumDescriptor* PlayerForceExitRsp_CmdId_descriptor();
inline const ::std::string& PlayerForceExitRsp_CmdId_Name(PlayerForceExitRsp_CmdId value) {
  return ::google::protobuf::internal::NameOfEnum(
    PlayerForceExitRsp_CmdId_descriptor(), value);
}
inline bool PlayerForceExitRsp_CmdId_Parse(
    const ::std::string& name, PlayerForceExitRsp_CmdId* value) {
  return ::google::protobuf::internal::ParseNamedEnum<PlayerForceExitRsp_CmdId>(
    PlayerForceExitRsp_CmdId_descriptor(), name, value);
}
enum PlayerInjectFixNotify_CmdId {
  PlayerInjectFixNotify_CmdId_NONE = 0,
  PlayerInjectFixNotify_CmdId_CMD_ID = 132,
  PlayerInjectFixNotify_CmdId_ENET_CHANNEL_ID = 0,
  PlayerInjectFixNotify_CmdId_ENET_IS_RELIABLE = 1,
  PlayerInjectFixNotify_CmdId_PlayerInjectFixNotify_CmdId_INT_MIN_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32min,
  PlayerInjectFixNotify_CmdId_PlayerInjectFixNotify_CmdId_INT_MAX_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32max
};
bool PlayerInjectFixNotify_CmdId_IsValid(int value);
const PlayerInjectFixNotify_CmdId PlayerInjectFixNotify_CmdId_CmdId_MIN = PlayerInjectFixNotify_CmdId_NONE;
const PlayerInjectFixNotify_CmdId PlayerInjectFixNotify_CmdId_CmdId_MAX = PlayerInjectFixNotify_CmdId_CMD_ID;
const int PlayerInjectFixNotify_CmdId_CmdId_ARRAYSIZE = PlayerInjectFixNotify_CmdId_CmdId_MAX + 1;

const ::google::protobuf::EnumDescriptor* PlayerInjectFixNotify_CmdId_descriptor();
inline const ::std::string& PlayerInjectFixNotify_CmdId_Name(PlayerInjectFixNotify_CmdId value) {
  return ::google::protobuf::internal::NameOfEnum(
    PlayerInjectFixNotify_CmdId_descriptor(), value);
}
inline bool PlayerInjectFixNotify_CmdId_Parse(
    const ::std::string& name, PlayerInjectFixNotify_CmdId* value) {
  return ::google::protobuf::internal::ParseNamedEnum<PlayerInjectFixNotify_CmdId>(
    PlayerInjectFixNotify_CmdId_descriptor(), name, value);
}
enum TaskVarNotify_CmdId {
  TaskVarNotify_CmdId_NONE = 0,
  TaskVarNotify_CmdId_CMD_ID = 160,
  TaskVarNotify_CmdId_ENET_CHANNEL_ID = 0,
  TaskVarNotify_CmdId_ENET_IS_RELIABLE = 1,
  TaskVarNotify_CmdId_TaskVarNotify_CmdId_INT_MIN_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32min,
  TaskVarNotify_CmdId_TaskVarNotify_CmdId_INT_MAX_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32max
};
bool TaskVarNotify_CmdId_IsValid(int value);
const TaskVarNotify_CmdId TaskVarNotify_CmdId_CmdId_MIN = TaskVarNotify_CmdId_NONE;
const TaskVarNotify_CmdId TaskVarNotify_CmdId_CmdId_MAX = TaskVarNotify_CmdId_CMD_ID;
const int TaskVarNotify_CmdId_CmdId_ARRAYSIZE = TaskVarNotify_CmdId_CmdId_MAX + 1;

const ::google::protobuf::EnumDescriptor* TaskVarNotify_CmdId_descriptor();
inline const ::std::string& TaskVarNotify_CmdId_Name(TaskVarNotify_CmdId value) {
  return ::google::protobuf::internal::NameOfEnum(
    TaskVarNotify_CmdId_descriptor(), value);
}
inline bool TaskVarNotify_CmdId_Parse(
    const ::std::string& name, TaskVarNotify_CmdId* value) {
  return ::google::protobuf::internal::ParseNamedEnum<TaskVarNotify_CmdId>(
    TaskVarNotify_CmdId_descriptor(), name, value);
}
enum ClientLockGameTimeNotify_CmdId {
  ClientLockGameTimeNotify_CmdId_NONE = 0,
  ClientLockGameTimeNotify_CmdId_CMD_ID = 114,
  ClientLockGameTimeNotify_CmdId_ENET_CHANNEL_ID = 0,
  ClientLockGameTimeNotify_CmdId_ENET_IS_RELIABLE = 1,
  ClientLockGameTimeNotify_CmdId_IS_ALLOW_CLIENT = 1,
  ClientLockGameTimeNotify_CmdId_ClientLockGameTimeNotify_CmdId_INT_MIN_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32min,
  ClientLockGameTimeNotify_CmdId_ClientLockGameTimeNotify_CmdId_INT_MAX_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32max
};
bool ClientLockGameTimeNotify_CmdId_IsValid(int value);
const ClientLockGameTimeNotify_CmdId ClientLockGameTimeNotify_CmdId_CmdId_MIN = ClientLockGameTimeNotify_CmdId_NONE;
const ClientLockGameTimeNotify_CmdId ClientLockGameTimeNotify_CmdId_CmdId_MAX = ClientLockGameTimeNotify_CmdId_CMD_ID;
const int ClientLockGameTimeNotify_CmdId_CmdId_ARRAYSIZE = ClientLockGameTimeNotify_CmdId_CmdId_MAX + 1;

const ::google::protobuf::EnumDescriptor* ClientLockGameTimeNotify_CmdId_descriptor();
inline const ::std::string& ClientLockGameTimeNotify_CmdId_Name(ClientLockGameTimeNotify_CmdId value) {
  return ::google::protobuf::internal::NameOfEnum(
    ClientLockGameTimeNotify_CmdId_descriptor(), value);
}
inline bool ClientLockGameTimeNotify_CmdId_Parse(
    const ::std::string& name, ClientLockGameTimeNotify_CmdId* value) {
  return ::google::protobuf::internal::ParseNamedEnum<ClientLockGameTimeNotify_CmdId>(
    ClientLockGameTimeNotify_CmdId_descriptor(), name, value);
}
enum GetNextResourceInfoReq_CmdId {
  GetNextResourceInfoReq_CmdId_NONE = 0,
  GetNextResourceInfoReq_CmdId_CMD_ID = 192,
  GetNextResourceInfoReq_CmdId_ENET_CHANNEL_ID = 0,
  GetNextResourceInfoReq_CmdId_ENET_IS_RELIABLE = 1,
  GetNextResourceInfoReq_CmdId_IS_ALLOW_CLIENT = 1,
  GetNextResourceInfoReq_CmdId_GetNextResourceInfoReq_CmdId_INT_MIN_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32min,
  GetNextResourceInfoReq_CmdId_GetNextResourceInfoReq_CmdId_INT_MAX_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32max
};
bool GetNextResourceInfoReq_CmdId_IsValid(int value);
const GetNextResourceInfoReq_CmdId GetNextResourceInfoReq_CmdId_CmdId_MIN = GetNextResourceInfoReq_CmdId_NONE;
const GetNextResourceInfoReq_CmdId GetNextResourceInfoReq_CmdId_CmdId_MAX = GetNextResourceInfoReq_CmdId_CMD_ID;
const int GetNextResourceInfoReq_CmdId_CmdId_ARRAYSIZE = GetNextResourceInfoReq_CmdId_CmdId_MAX + 1;

const ::google::protobuf::EnumDescriptor* GetNextResourceInfoReq_CmdId_descriptor();
inline const ::std::string& GetNextResourceInfoReq_CmdId_Name(GetNextResourceInfoReq_CmdId value) {
  return ::google::protobuf::internal::NameOfEnum(
    GetNextResourceInfoReq_CmdId_descriptor(), value);
}
inline bool GetNextResourceInfoReq_CmdId_Parse(
    const ::std::string& name, GetNextResourceInfoReq_CmdId* value) {
  return ::google::protobuf::internal::ParseNamedEnum<GetNextResourceInfoReq_CmdId>(
    GetNextResourceInfoReq_CmdId_descriptor(), name, value);
}
enum GetNextResourceInfoRsp_CmdId {
  GetNextResourceInfoRsp_CmdId_NONE = 0,
  GetNextResourceInfoRsp_CmdId_CMD_ID = 120,
  GetNextResourceInfoRsp_CmdId_ENET_CHANNEL_ID = 0,
  GetNextResourceInfoRsp_CmdId_ENET_IS_RELIABLE = 1,
  GetNextResourceInfoRsp_CmdId_GetNextResourceInfoRsp_CmdId_INT_MIN_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32min,
  GetNextResourceInfoRsp_CmdId_GetNextResourceInfoRsp_CmdId_INT_MAX_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32max
};
bool GetNextResourceInfoRsp_CmdId_IsValid(int value);
const GetNextResourceInfoRsp_CmdId GetNextResourceInfoRsp_CmdId_CmdId_MIN = GetNextResourceInfoRsp_CmdId_NONE;
const GetNextResourceInfoRsp_CmdId GetNextResourceInfoRsp_CmdId_CmdId_MAX = GetNextResourceInfoRsp_CmdId_CMD_ID;
const int GetNextResourceInfoRsp_CmdId_CmdId_ARRAYSIZE = GetNextResourceInfoRsp_CmdId_CmdId_MAX + 1;

const ::google::protobuf::EnumDescriptor* GetNextResourceInfoRsp_CmdId_descriptor();
inline const ::std::string& GetNextResourceInfoRsp_CmdId_Name(GetNextResourceInfoRsp_CmdId value) {
  return ::google::protobuf::internal::NameOfEnum(
    GetNextResourceInfoRsp_CmdId_descriptor(), value);
}
inline bool GetNextResourceInfoRsp_CmdId_Parse(
    const ::std::string& name, GetNextResourceInfoRsp_CmdId* value) {
  return ::google::protobuf::internal::ParseNamedEnum<GetNextResourceInfoRsp_CmdId>(
    GetNextResourceInfoRsp_CmdId_descriptor(), name, value);
}
enum AdjustWorldLevelReq_CmdId {
  AdjustWorldLevelReq_CmdId_NONE = 0,
  AdjustWorldLevelReq_CmdId_CMD_ID = 164,
  AdjustWorldLevelReq_CmdId_ENET_CHANNEL_ID = 0,
  AdjustWorldLevelReq_CmdId_ENET_IS_RELIABLE = 1,
  AdjustWorldLevelReq_CmdId_IS_ALLOW_CLIENT = 1,
  AdjustWorldLevelReq_CmdId_AdjustWorldLevelReq_CmdId_INT_MIN_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32min,
  AdjustWorldLevelReq_CmdId_AdjustWorldLevelReq_CmdId_INT_MAX_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32max
};
bool AdjustWorldLevelReq_CmdId_IsValid(int value);
const AdjustWorldLevelReq_CmdId AdjustWorldLevelReq_CmdId_CmdId_MIN = AdjustWorldLevelReq_CmdId_NONE;
const AdjustWorldLevelReq_CmdId AdjustWorldLevelReq_CmdId_CmdId_MAX = AdjustWorldLevelReq_CmdId_CMD_ID;
const int AdjustWorldLevelReq_CmdId_CmdId_ARRAYSIZE = AdjustWorldLevelReq_CmdId_CmdId_MAX + 1;

const ::google::protobuf::EnumDescriptor* AdjustWorldLevelReq_CmdId_descriptor();
inline const ::std::string& AdjustWorldLevelReq_CmdId_Name(AdjustWorldLevelReq_CmdId value) {
  return ::google::protobuf::internal::NameOfEnum(
    AdjustWorldLevelReq_CmdId_descriptor(), value);
}
inline bool AdjustWorldLevelReq_CmdId_Parse(
    const ::std::string& name, AdjustWorldLevelReq_CmdId* value) {
  return ::google::protobuf::internal::ParseNamedEnum<AdjustWorldLevelReq_CmdId>(
    AdjustWorldLevelReq_CmdId_descriptor(), name, value);
}
enum AdjustWorldLevelRsp_CmdId {
  AdjustWorldLevelRsp_CmdId_NONE = 0,
  AdjustWorldLevelRsp_CmdId_CMD_ID = 138,
  AdjustWorldLevelRsp_CmdId_ENET_CHANNEL_ID = 0,
  AdjustWorldLevelRsp_CmdId_ENET_IS_RELIABLE = 1,
  AdjustWorldLevelRsp_CmdId_AdjustWorldLevelRsp_CmdId_INT_MIN_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32min,
  AdjustWorldLevelRsp_CmdId_AdjustWorldLevelRsp_CmdId_INT_MAX_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32max
};
bool AdjustWorldLevelRsp_CmdId_IsValid(int value);
const AdjustWorldLevelRsp_CmdId AdjustWorldLevelRsp_CmdId_CmdId_MIN = AdjustWorldLevelRsp_CmdId_NONE;
const AdjustWorldLevelRsp_CmdId AdjustWorldLevelRsp_CmdId_CmdId_MAX = AdjustWorldLevelRsp_CmdId_CMD_ID;
const int AdjustWorldLevelRsp_CmdId_CmdId_ARRAYSIZE = AdjustWorldLevelRsp_CmdId_CmdId_MAX + 1;

const ::google::protobuf::EnumDescriptor* AdjustWorldLevelRsp_CmdId_descriptor();
inline const ::std::string& AdjustWorldLevelRsp_CmdId_Name(AdjustWorldLevelRsp_CmdId value) {
  return ::google::protobuf::internal::NameOfEnum(
    AdjustWorldLevelRsp_CmdId_descriptor(), value);
}
inline bool AdjustWorldLevelRsp_CmdId_Parse(
    const ::std::string& name, AdjustWorldLevelRsp_CmdId* value) {
  return ::google::protobuf::internal::ParseNamedEnum<AdjustWorldLevelRsp_CmdId>(
    AdjustWorldLevelRsp_CmdId_descriptor(), name, value);
}
enum DailyTaskFilterCityReq_CmdId {
  DailyTaskFilterCityReq_CmdId_NONE = 0,
  DailyTaskFilterCityReq_CmdId_CMD_ID = 111,
  DailyTaskFilterCityReq_CmdId_ENET_CHANNEL_ID = 0,
  DailyTaskFilterCityReq_CmdId_ENET_IS_RELIABLE = 1,
  DailyTaskFilterCityReq_CmdId_IS_ALLOW_CLIENT = 1,
  DailyTaskFilterCityReq_CmdId_DailyTaskFilterCityReq_CmdId_INT_MIN_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32min,
  DailyTaskFilterCityReq_CmdId_DailyTaskFilterCityReq_CmdId_INT_MAX_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32max
};
bool DailyTaskFilterCityReq_CmdId_IsValid(int value);
const DailyTaskFilterCityReq_CmdId DailyTaskFilterCityReq_CmdId_CmdId_MIN = DailyTaskFilterCityReq_CmdId_NONE;
const DailyTaskFilterCityReq_CmdId DailyTaskFilterCityReq_CmdId_CmdId_MAX = DailyTaskFilterCityReq_CmdId_CMD_ID;
const int DailyTaskFilterCityReq_CmdId_CmdId_ARRAYSIZE = DailyTaskFilterCityReq_CmdId_CmdId_MAX + 1;

const ::google::protobuf::EnumDescriptor* DailyTaskFilterCityReq_CmdId_descriptor();
inline const ::std::string& DailyTaskFilterCityReq_CmdId_Name(DailyTaskFilterCityReq_CmdId value) {
  return ::google::protobuf::internal::NameOfEnum(
    DailyTaskFilterCityReq_CmdId_descriptor(), value);
}
inline bool DailyTaskFilterCityReq_CmdId_Parse(
    const ::std::string& name, DailyTaskFilterCityReq_CmdId* value) {
  return ::google::protobuf::internal::ParseNamedEnum<DailyTaskFilterCityReq_CmdId>(
    DailyTaskFilterCityReq_CmdId_descriptor(), name, value);
}
enum DailyTaskFilterCityRsp_CmdId {
  DailyTaskFilterCityRsp_CmdId_NONE = 0,
  DailyTaskFilterCityRsp_CmdId_CMD_ID = 144,
  DailyTaskFilterCityRsp_CmdId_ENET_CHANNEL_ID = 0,
  DailyTaskFilterCityRsp_CmdId_ENET_IS_RELIABLE = 1,
  DailyTaskFilterCityRsp_CmdId_DailyTaskFilterCityRsp_CmdId_INT_MIN_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32min,
  DailyTaskFilterCityRsp_CmdId_DailyTaskFilterCityRsp_CmdId_INT_MAX_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32max
};
bool DailyTaskFilterCityRsp_CmdId_IsValid(int value);
const DailyTaskFilterCityRsp_CmdId DailyTaskFilterCityRsp_CmdId_CmdId_MIN = DailyTaskFilterCityRsp_CmdId_NONE;
const DailyTaskFilterCityRsp_CmdId DailyTaskFilterCityRsp_CmdId_CmdId_MAX = DailyTaskFilterCityRsp_CmdId_CMD_ID;
const int DailyTaskFilterCityRsp_CmdId_CmdId_ARRAYSIZE = DailyTaskFilterCityRsp_CmdId_CmdId_MAX + 1;

const ::google::protobuf::EnumDescriptor* DailyTaskFilterCityRsp_CmdId_descriptor();
inline const ::std::string& DailyTaskFilterCityRsp_CmdId_Name(DailyTaskFilterCityRsp_CmdId value) {
  return ::google::protobuf::internal::NameOfEnum(
    DailyTaskFilterCityRsp_CmdId_descriptor(), value);
}
inline bool DailyTaskFilterCityRsp_CmdId_Parse(
    const ::std::string& name, DailyTaskFilterCityRsp_CmdId* value) {
  return ::google::protobuf::internal::ParseNamedEnum<DailyTaskFilterCityRsp_CmdId>(
    DailyTaskFilterCityRsp_CmdId_descriptor(), name, value);
}
enum DailyTaskUnlockedCitiesNotify_CmdId {
  DailyTaskUnlockedCitiesNotify_CmdId_NONE = 0,
  DailyTaskUnlockedCitiesNotify_CmdId_CMD_ID = 186,
  DailyTaskUnlockedCitiesNotify_CmdId_ENET_CHANNEL_ID = 0,
  DailyTaskUnlockedCitiesNotify_CmdId_ENET_IS_RELIABLE = 1,
  DailyTaskUnlockedCitiesNotify_CmdId_DailyTaskUnlockedCitiesNotify_CmdId_INT_MIN_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32min,
  DailyTaskUnlockedCitiesNotify_CmdId_DailyTaskUnlockedCitiesNotify_CmdId_INT_MAX_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32max
};
bool DailyTaskUnlockedCitiesNotify_CmdId_IsValid(int value);
const DailyTaskUnlockedCitiesNotify_CmdId DailyTaskUnlockedCitiesNotify_CmdId_CmdId_MIN = DailyTaskUnlockedCitiesNotify_CmdId_NONE;
const DailyTaskUnlockedCitiesNotify_CmdId DailyTaskUnlockedCitiesNotify_CmdId_CmdId_MAX = DailyTaskUnlockedCitiesNotify_CmdId_CMD_ID;
const int DailyTaskUnlockedCitiesNotify_CmdId_CmdId_ARRAYSIZE = DailyTaskUnlockedCitiesNotify_CmdId_CmdId_MAX + 1;

const ::google::protobuf::EnumDescriptor* DailyTaskUnlockedCitiesNotify_CmdId_descriptor();
inline const ::std::string& DailyTaskUnlockedCitiesNotify_CmdId_Name(DailyTaskUnlockedCitiesNotify_CmdId value) {
  return ::google::protobuf::internal::NameOfEnum(
    DailyTaskUnlockedCitiesNotify_CmdId_descriptor(), value);
}
inline bool DailyTaskUnlockedCitiesNotify_CmdId_Parse(
    const ::std::string& name, DailyTaskUnlockedCitiesNotify_CmdId* value) {
  return ::google::protobuf::internal::ParseNamedEnum<DailyTaskUnlockedCitiesNotify_CmdId>(
    DailyTaskUnlockedCitiesNotify_CmdId_descriptor(), name, value);
}
enum ExclusiveRuleNotify_CmdId {
  ExclusiveRuleNotify_CmdId_NONE = 0,
  ExclusiveRuleNotify_CmdId_CMD_ID = 101,
  ExclusiveRuleNotify_CmdId_ENET_CHANNEL_ID = 0,
  ExclusiveRuleNotify_CmdId_ENET_IS_RELIABLE = 1,
  ExclusiveRuleNotify_CmdId_ExclusiveRuleNotify_CmdId_INT_MIN_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32min,
  ExclusiveRuleNotify_CmdId_ExclusiveRuleNotify_CmdId_INT_MAX_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32max
};
bool ExclusiveRuleNotify_CmdId_IsValid(int value);
const ExclusiveRuleNotify_CmdId ExclusiveRuleNotify_CmdId_CmdId_MIN = ExclusiveRuleNotify_CmdId_NONE;
const ExclusiveRuleNotify_CmdId ExclusiveRuleNotify_CmdId_CmdId_MAX = ExclusiveRuleNotify_CmdId_CMD_ID;
const int ExclusiveRuleNotify_CmdId_CmdId_ARRAYSIZE = ExclusiveRuleNotify_CmdId_CmdId_MAX + 1;

const ::google::protobuf::EnumDescriptor* ExclusiveRuleNotify_CmdId_descriptor();
inline const ::std::string& ExclusiveRuleNotify_CmdId_Name(ExclusiveRuleNotify_CmdId value) {
  return ::google::protobuf::internal::NameOfEnum(
    ExclusiveRuleNotify_CmdId_descriptor(), value);
}
inline bool ExclusiveRuleNotify_CmdId_Parse(
    const ::std::string& name, ExclusiveRuleNotify_CmdId* value) {
  return ::google::protobuf::internal::ParseNamedEnum<ExclusiveRuleNotify_CmdId>(
    ExclusiveRuleNotify_CmdId_descriptor(), name, value);
}
enum CompoundUnlockNotify_CmdId {
  CompoundUnlockNotify_CmdId_NONE = 0,
  CompoundUnlockNotify_CmdId_CMD_ID = 128,
  CompoundUnlockNotify_CmdId_ENET_CHANNEL_ID = 0,
  CompoundUnlockNotify_CmdId_ENET_IS_RELIABLE = 1,
  CompoundUnlockNotify_CmdId_CompoundUnlockNotify_CmdId_INT_MIN_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32min,
  CompoundUnlockNotify_CmdId_CompoundUnlockNotify_CmdId_INT_MAX_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32max
};
bool CompoundUnlockNotify_CmdId_IsValid(int value);
const CompoundUnlockNotify_CmdId CompoundUnlockNotify_CmdId_CmdId_MIN = CompoundUnlockNotify_CmdId_NONE;
const CompoundUnlockNotify_CmdId CompoundUnlockNotify_CmdId_CmdId_MAX = CompoundUnlockNotify_CmdId_CMD_ID;
const int CompoundUnlockNotify_CmdId_CmdId_ARRAYSIZE = CompoundUnlockNotify_CmdId_CmdId_MAX + 1;

const ::google::protobuf::EnumDescriptor* CompoundUnlockNotify_CmdId_descriptor();
inline const ::std::string& CompoundUnlockNotify_CmdId_Name(CompoundUnlockNotify_CmdId value) {
  return ::google::protobuf::internal::NameOfEnum(
    CompoundUnlockNotify_CmdId_descriptor(), value);
}
inline bool CompoundUnlockNotify_CmdId_Parse(
    const ::std::string& name, CompoundUnlockNotify_CmdId* value) {
  return ::google::protobuf::internal::ParseNamedEnum<CompoundUnlockNotify_CmdId>(
    CompoundUnlockNotify_CmdId_descriptor(), name, value);
}
enum GetGameplayRecommendationReq_CmdId {
  GetGameplayRecommendationReq_CmdId_NONE = 0,
  GetGameplayRecommendationReq_CmdId_CMD_ID = 151,
  GetGameplayRecommendationReq_CmdId_ENET_CHANNEL_ID = 0,
  GetGameplayRecommendationReq_CmdId_ENET_IS_RELIABLE = 1,
  GetGameplayRecommendationReq_CmdId_IS_ALLOW_CLIENT = 1,
  GetGameplayRecommendationReq_CmdId_GetGameplayRecommendationReq_CmdId_INT_MIN_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32min,
  GetGameplayRecommendationReq_CmdId_GetGameplayRecommendationReq_CmdId_INT_MAX_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32max
};
bool GetGameplayRecommendationReq_CmdId_IsValid(int value);
const GetGameplayRecommendationReq_CmdId GetGameplayRecommendationReq_CmdId_CmdId_MIN = GetGameplayRecommendationReq_CmdId_NONE;
const GetGameplayRecommendationReq_CmdId GetGameplayRecommendationReq_CmdId_CmdId_MAX = GetGameplayRecommendationReq_CmdId_CMD_ID;
const int GetGameplayRecommendationReq_CmdId_CmdId_ARRAYSIZE = GetGameplayRecommendationReq_CmdId_CmdId_MAX + 1;

const ::google::protobuf::EnumDescriptor* GetGameplayRecommendationReq_CmdId_descriptor();
inline const ::std::string& GetGameplayRecommendationReq_CmdId_Name(GetGameplayRecommendationReq_CmdId value) {
  return ::google::protobuf::internal::NameOfEnum(
    GetGameplayRecommendationReq_CmdId_descriptor(), value);
}
inline bool GetGameplayRecommendationReq_CmdId_Parse(
    const ::std::string& name, GetGameplayRecommendationReq_CmdId* value) {
  return ::google::protobuf::internal::ParseNamedEnum<GetGameplayRecommendationReq_CmdId>(
    GetGameplayRecommendationReq_CmdId_descriptor(), name, value);
}
enum GetGameplayRecommendationRsp_CmdId {
  GetGameplayRecommendationRsp_CmdId_NONE = 0,
  GetGameplayRecommendationRsp_CmdId_CMD_ID = 123,
  GetGameplayRecommendationRsp_CmdId_ENET_CHANNEL_ID = 0,
  GetGameplayRecommendationRsp_CmdId_ENET_IS_RELIABLE = 1,
  GetGameplayRecommendationRsp_CmdId_GetGameplayRecommendationRsp_CmdId_INT_MIN_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32min,
  GetGameplayRecommendationRsp_CmdId_GetGameplayRecommendationRsp_CmdId_INT_MAX_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32max
};
bool GetGameplayRecommendationRsp_CmdId_IsValid(int value);
const GetGameplayRecommendationRsp_CmdId GetGameplayRecommendationRsp_CmdId_CmdId_MIN = GetGameplayRecommendationRsp_CmdId_NONE;
const GetGameplayRecommendationRsp_CmdId GetGameplayRecommendationRsp_CmdId_CmdId_MAX = GetGameplayRecommendationRsp_CmdId_CMD_ID;
const int GetGameplayRecommendationRsp_CmdId_CmdId_ARRAYSIZE = GetGameplayRecommendationRsp_CmdId_CmdId_MAX + 1;

const ::google::protobuf::EnumDescriptor* GetGameplayRecommendationRsp_CmdId_descriptor();
inline const ::std::string& GetGameplayRecommendationRsp_CmdId_Name(GetGameplayRecommendationRsp_CmdId value) {
  return ::google::protobuf::internal::NameOfEnum(
    GetGameplayRecommendationRsp_CmdId_descriptor(), value);
}
inline bool GetGameplayRecommendationRsp_CmdId_Parse(
    const ::std::string& name, GetGameplayRecommendationRsp_CmdId* value) {
  return ::google::protobuf::internal::ParseNamedEnum<GetGameplayRecommendationRsp_CmdId>(
    GetGameplayRecommendationRsp_CmdId_descriptor(), name, value);
}
enum TakeBackGivingItemReq_CmdId {
  TakeBackGivingItemReq_CmdId_NONE = 0,
  TakeBackGivingItemReq_CmdId_CMD_ID = 171,
  TakeBackGivingItemReq_CmdId_ENET_CHANNEL_ID = 0,
  TakeBackGivingItemReq_CmdId_ENET_IS_RELIABLE = 1,
  TakeBackGivingItemReq_CmdId_IS_ALLOW_CLIENT = 1,
  TakeBackGivingItemReq_CmdId_TakeBackGivingItemReq_CmdId_INT_MIN_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32min,
  TakeBackGivingItemReq_CmdId_TakeBackGivingItemReq_CmdId_INT_MAX_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32max
};
bool TakeBackGivingItemReq_CmdId_IsValid(int value);
const TakeBackGivingItemReq_CmdId TakeBackGivingItemReq_CmdId_CmdId_MIN = TakeBackGivingItemReq_CmdId_NONE;
const TakeBackGivingItemReq_CmdId TakeBackGivingItemReq_CmdId_CmdId_MAX = TakeBackGivingItemReq_CmdId_CMD_ID;
const int TakeBackGivingItemReq_CmdId_CmdId_ARRAYSIZE = TakeBackGivingItemReq_CmdId_CmdId_MAX + 1;

const ::google::protobuf::EnumDescriptor* TakeBackGivingItemReq_CmdId_descriptor();
inline const ::std::string& TakeBackGivingItemReq_CmdId_Name(TakeBackGivingItemReq_CmdId value) {
  return ::google::protobuf::internal::NameOfEnum(
    TakeBackGivingItemReq_CmdId_descriptor(), value);
}
inline bool TakeBackGivingItemReq_CmdId_Parse(
    const ::std::string& name, TakeBackGivingItemReq_CmdId* value) {
  return ::google::protobuf::internal::ParseNamedEnum<TakeBackGivingItemReq_CmdId>(
    TakeBackGivingItemReq_CmdId_descriptor(), name, value);
}
enum TakeBackGivingItemRsp_CmdId {
  TakeBackGivingItemRsp_CmdId_NONE = 0,
  TakeBackGivingItemRsp_CmdId_CMD_ID = 145,
  TakeBackGivingItemRsp_CmdId_ENET_CHANNEL_ID = 0,
  TakeBackGivingItemRsp_CmdId_ENET_IS_RELIABLE = 1,
  TakeBackGivingItemRsp_CmdId_TakeBackGivingItemRsp_CmdId_INT_MIN_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32min,
  TakeBackGivingItemRsp_CmdId_TakeBackGivingItemRsp_CmdId_INT_MAX_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32max
};
bool TakeBackGivingItemRsp_CmdId_IsValid(int value);
const TakeBackGivingItemRsp_CmdId TakeBackGivingItemRsp_CmdId_CmdId_MIN = TakeBackGivingItemRsp_CmdId_NONE;
const TakeBackGivingItemRsp_CmdId TakeBackGivingItemRsp_CmdId_CmdId_MAX = TakeBackGivingItemRsp_CmdId_CMD_ID;
const int TakeBackGivingItemRsp_CmdId_CmdId_ARRAYSIZE = TakeBackGivingItemRsp_CmdId_CmdId_MAX + 1;

const ::google::protobuf::EnumDescriptor* TakeBackGivingItemRsp_CmdId_descriptor();
inline const ::std::string& TakeBackGivingItemRsp_CmdId_Name(TakeBackGivingItemRsp_CmdId value) {
  return ::google::protobuf::internal::NameOfEnum(
    TakeBackGivingItemRsp_CmdId_descriptor(), value);
}
inline bool TakeBackGivingItemRsp_CmdId_Parse(
    const ::std::string& name, TakeBackGivingItemRsp_CmdId* value) {
  return ::google::protobuf::internal::ParseNamedEnum<TakeBackGivingItemRsp_CmdId>(
    TakeBackGivingItemRsp_CmdId_descriptor(), name, value);
}
enum PlayerNicknameAuditDataNotify_CmdId {
  PlayerNicknameAuditDataNotify_CmdId_NONE = 0,
  PlayerNicknameAuditDataNotify_CmdId_CMD_ID = 108,
  PlayerNicknameAuditDataNotify_CmdId_ENET_CHANNEL_ID = 0,
  PlayerNicknameAuditDataNotify_CmdId_ENET_IS_RELIABLE = 1,
  PlayerNicknameAuditDataNotify_CmdId_PlayerNicknameAuditDataNotify_CmdId_INT_MIN_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32min,
  PlayerNicknameAuditDataNotify_CmdId_PlayerNicknameAuditDataNotify_CmdId_INT_MAX_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32max
};
bool PlayerNicknameAuditDataNotify_CmdId_IsValid(int value);
const PlayerNicknameAuditDataNotify_CmdId PlayerNicknameAuditDataNotify_CmdId_CmdId_MIN = PlayerNicknameAuditDataNotify_CmdId_NONE;
const PlayerNicknameAuditDataNotify_CmdId PlayerNicknameAuditDataNotify_CmdId_CmdId_MAX = PlayerNicknameAuditDataNotify_CmdId_CMD_ID;
const int PlayerNicknameAuditDataNotify_CmdId_CmdId_ARRAYSIZE = PlayerNicknameAuditDataNotify_CmdId_CmdId_MAX + 1;

const ::google::protobuf::EnumDescriptor* PlayerNicknameAuditDataNotify_CmdId_descriptor();
inline const ::std::string& PlayerNicknameAuditDataNotify_CmdId_Name(PlayerNicknameAuditDataNotify_CmdId value) {
  return ::google::protobuf::internal::NameOfEnum(
    PlayerNicknameAuditDataNotify_CmdId_descriptor(), value);
}
inline bool PlayerNicknameAuditDataNotify_CmdId_Parse(
    const ::std::string& name, PlayerNicknameAuditDataNotify_CmdId* value) {
  return ::google::protobuf::internal::ParseNamedEnum<PlayerNicknameAuditDataNotify_CmdId>(
    PlayerNicknameAuditDataNotify_CmdId_descriptor(), name, value);
}
enum PlayerNicknameNotify_CmdId {
  PlayerNicknameNotify_CmdId_NONE = 0,
  PlayerNicknameNotify_CmdId_CMD_ID = 109,
  PlayerNicknameNotify_CmdId_ENET_CHANNEL_ID = 0,
  PlayerNicknameNotify_CmdId_ENET_IS_RELIABLE = 1,
  PlayerNicknameNotify_CmdId_PlayerNicknameNotify_CmdId_INT_MIN_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32min,
  PlayerNicknameNotify_CmdId_PlayerNicknameNotify_CmdId_INT_MAX_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32max
};
bool PlayerNicknameNotify_CmdId_IsValid(int value);
const PlayerNicknameNotify_CmdId PlayerNicknameNotify_CmdId_CmdId_MIN = PlayerNicknameNotify_CmdId_NONE;
const PlayerNicknameNotify_CmdId PlayerNicknameNotify_CmdId_CmdId_MAX = PlayerNicknameNotify_CmdId_CMD_ID;
const int PlayerNicknameNotify_CmdId_CmdId_ARRAYSIZE = PlayerNicknameNotify_CmdId_CmdId_MAX + 1;

const ::google::protobuf::EnumDescriptor* PlayerNicknameNotify_CmdId_descriptor();
inline const ::std::string& PlayerNicknameNotify_CmdId_Name(PlayerNicknameNotify_CmdId value) {
  return ::google::protobuf::internal::NameOfEnum(
    PlayerNicknameNotify_CmdId_descriptor(), value);
}
inline bool PlayerNicknameNotify_CmdId_Parse(
    const ::std::string& name, PlayerNicknameNotify_CmdId* value) {
  return ::google::protobuf::internal::ParseNamedEnum<PlayerNicknameNotify_CmdId>(
    PlayerNicknameNotify_CmdId_descriptor(), name, value);
}
enum NicknameAuditConfigNotify_CmdId {
  NicknameAuditConfigNotify_CmdId_NONE = 0,
  NicknameAuditConfigNotify_CmdId_CMD_ID = 152,
  NicknameAuditConfigNotify_CmdId_ENET_CHANNEL_ID = 0,
  NicknameAuditConfigNotify_CmdId_ENET_IS_RELIABLE = 1,
  NicknameAuditConfigNotify_CmdId_NicknameAuditConfigNotify_CmdId_INT_MIN_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32min,
  NicknameAuditConfigNotify_CmdId_NicknameAuditConfigNotify_CmdId_INT_MAX_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32max
};
bool NicknameAuditConfigNotify_CmdId_IsValid(int value);
const NicknameAuditConfigNotify_CmdId NicknameAuditConfigNotify_CmdId_CmdId_MIN = NicknameAuditConfigNotify_CmdId_NONE;
const NicknameAuditConfigNotify_CmdId NicknameAuditConfigNotify_CmdId_CmdId_MAX = NicknameAuditConfigNotify_CmdId_CMD_ID;
const int NicknameAuditConfigNotify_CmdId_CmdId_ARRAYSIZE = NicknameAuditConfigNotify_CmdId_CmdId_MAX + 1;

const ::google::protobuf::EnumDescriptor* NicknameAuditConfigNotify_CmdId_descriptor();
inline const ::std::string& NicknameAuditConfigNotify_CmdId_Name(NicknameAuditConfigNotify_CmdId value) {
  return ::google::protobuf::internal::NameOfEnum(
    NicknameAuditConfigNotify_CmdId_descriptor(), value);
}
inline bool NicknameAuditConfigNotify_CmdId_Parse(
    const ::std::string& name, NicknameAuditConfigNotify_CmdId* value) {
  return ::google::protobuf::internal::ParseNamedEnum<NicknameAuditConfigNotify_CmdId>(
    NicknameAuditConfigNotify_CmdId_descriptor(), name, value);
}
enum ReadNicknameAuditReq_CmdId {
  ReadNicknameAuditReq_CmdId_NONE = 0,
  ReadNicknameAuditReq_CmdId_CMD_ID = 177,
  ReadNicknameAuditReq_CmdId_ENET_CHANNEL_ID = 0,
  ReadNicknameAuditReq_CmdId_ENET_IS_RELIABLE = 1,
  ReadNicknameAuditReq_CmdId_IS_ALLOW_CLIENT = 1,
  ReadNicknameAuditReq_CmdId_ReadNicknameAuditReq_CmdId_INT_MIN_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32min,
  ReadNicknameAuditReq_CmdId_ReadNicknameAuditReq_CmdId_INT_MAX_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32max
};
bool ReadNicknameAuditReq_CmdId_IsValid(int value);
const ReadNicknameAuditReq_CmdId ReadNicknameAuditReq_CmdId_CmdId_MIN = ReadNicknameAuditReq_CmdId_NONE;
const ReadNicknameAuditReq_CmdId ReadNicknameAuditReq_CmdId_CmdId_MAX = ReadNicknameAuditReq_CmdId_CMD_ID;
const int ReadNicknameAuditReq_CmdId_CmdId_ARRAYSIZE = ReadNicknameAuditReq_CmdId_CmdId_MAX + 1;

const ::google::protobuf::EnumDescriptor* ReadNicknameAuditReq_CmdId_descriptor();
inline const ::std::string& ReadNicknameAuditReq_CmdId_Name(ReadNicknameAuditReq_CmdId value) {
  return ::google::protobuf::internal::NameOfEnum(
    ReadNicknameAuditReq_CmdId_descriptor(), value);
}
inline bool ReadNicknameAuditReq_CmdId_Parse(
    const ::std::string& name, ReadNicknameAuditReq_CmdId* value) {
  return ::google::protobuf::internal::ParseNamedEnum<ReadNicknameAuditReq_CmdId>(
    ReadNicknameAuditReq_CmdId_descriptor(), name, value);
}
enum ReadNicknameAuditRsp_CmdId {
  ReadNicknameAuditRsp_CmdId_NONE = 0,
  ReadNicknameAuditRsp_CmdId_CMD_ID = 137,
  ReadNicknameAuditRsp_CmdId_ENET_CHANNEL_ID = 0,
  ReadNicknameAuditRsp_CmdId_ENET_IS_RELIABLE = 1,
  ReadNicknameAuditRsp_CmdId_ReadNicknameAuditRsp_CmdId_INT_MIN_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32min,
  ReadNicknameAuditRsp_CmdId_ReadNicknameAuditRsp_CmdId_INT_MAX_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32max
};
bool ReadNicknameAuditRsp_CmdId_IsValid(int value);
const ReadNicknameAuditRsp_CmdId ReadNicknameAuditRsp_CmdId_CmdId_MIN = ReadNicknameAuditRsp_CmdId_NONE;
const ReadNicknameAuditRsp_CmdId ReadNicknameAuditRsp_CmdId_CmdId_MAX = ReadNicknameAuditRsp_CmdId_CMD_ID;
const int ReadNicknameAuditRsp_CmdId_CmdId_ARRAYSIZE = ReadNicknameAuditRsp_CmdId_CmdId_MAX + 1;

const ::google::protobuf::EnumDescriptor* ReadNicknameAuditRsp_CmdId_descriptor();
inline const ::std::string& ReadNicknameAuditRsp_CmdId_Name(ReadNicknameAuditRsp_CmdId value) {
  return ::google::protobuf::internal::NameOfEnum(
    ReadNicknameAuditRsp_CmdId_descriptor(), value);
}
inline bool ReadNicknameAuditRsp_CmdId_Parse(
    const ::std::string& name, ReadNicknameAuditRsp_CmdId* value) {
  return ::google::protobuf::internal::ParseNamedEnum<ReadNicknameAuditRsp_CmdId>(
    ReadNicknameAuditRsp_CmdId_descriptor(), name, value);
}
enum PlayerCompoundMaterialBoostReq_CmdId {
  PlayerCompoundMaterialBoostReq_CmdId_NONE = 0,
  PlayerCompoundMaterialBoostReq_CmdId_CMD_ID = 185,
  PlayerCompoundMaterialBoostReq_CmdId_ENET_CHANNEL_ID = 0,
  PlayerCompoundMaterialBoostReq_CmdId_ENET_IS_RELIABLE = 1,
  PlayerCompoundMaterialBoostReq_CmdId_IS_ALLOW_CLIENT = 1,
  PlayerCompoundMaterialBoostReq_CmdId_PlayerCompoundMaterialBoostReq_CmdId_INT_MIN_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32min,
  PlayerCompoundMaterialBoostReq_CmdId_PlayerCompoundMaterialBoostReq_CmdId_INT_MAX_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32max
};
bool PlayerCompoundMaterialBoostReq_CmdId_IsValid(int value);
const PlayerCompoundMaterialBoostReq_CmdId PlayerCompoundMaterialBoostReq_CmdId_CmdId_MIN = PlayerCompoundMaterialBoostReq_CmdId_NONE;
const PlayerCompoundMaterialBoostReq_CmdId PlayerCompoundMaterialBoostReq_CmdId_CmdId_MAX = PlayerCompoundMaterialBoostReq_CmdId_CMD_ID;
const int PlayerCompoundMaterialBoostReq_CmdId_CmdId_ARRAYSIZE = PlayerCompoundMaterialBoostReq_CmdId_CmdId_MAX + 1;

const ::google::protobuf::EnumDescriptor* PlayerCompoundMaterialBoostReq_CmdId_descriptor();
inline const ::std::string& PlayerCompoundMaterialBoostReq_CmdId_Name(PlayerCompoundMaterialBoostReq_CmdId value) {
  return ::google::protobuf::internal::NameOfEnum(
    PlayerCompoundMaterialBoostReq_CmdId_descriptor(), value);
}
inline bool PlayerCompoundMaterialBoostReq_CmdId_Parse(
    const ::std::string& name, PlayerCompoundMaterialBoostReq_CmdId* value) {
  return ::google::protobuf::internal::ParseNamedEnum<PlayerCompoundMaterialBoostReq_CmdId>(
    PlayerCompoundMaterialBoostReq_CmdId_descriptor(), name, value);
}
enum PlayerCompoundMaterialBoostRsp_CmdId {
  PlayerCompoundMaterialBoostRsp_CmdId_NONE = 0,
  PlayerCompoundMaterialBoostRsp_CmdId_CMD_ID = 125,
  PlayerCompoundMaterialBoostRsp_CmdId_ENET_CHANNEL_ID = 0,
  PlayerCompoundMaterialBoostRsp_CmdId_ENET_IS_RELIABLE = 1,
  PlayerCompoundMaterialBoostRsp_CmdId_PlayerCompoundMaterialBoostRsp_CmdId_INT_MIN_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32min,
  PlayerCompoundMaterialBoostRsp_CmdId_PlayerCompoundMaterialBoostRsp_CmdId_INT_MAX_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32max
};
bool PlayerCompoundMaterialBoostRsp_CmdId_IsValid(int value);
const PlayerCompoundMaterialBoostRsp_CmdId PlayerCompoundMaterialBoostRsp_CmdId_CmdId_MIN = PlayerCompoundMaterialBoostRsp_CmdId_NONE;
const PlayerCompoundMaterialBoostRsp_CmdId PlayerCompoundMaterialBoostRsp_CmdId_CmdId_MAX = PlayerCompoundMaterialBoostRsp_CmdId_CMD_ID;
const int PlayerCompoundMaterialBoostRsp_CmdId_CmdId_ARRAYSIZE = PlayerCompoundMaterialBoostRsp_CmdId_CmdId_MAX + 1;

const ::google::protobuf::EnumDescriptor* PlayerCompoundMaterialBoostRsp_CmdId_descriptor();
inline const ::std::string& PlayerCompoundMaterialBoostRsp_CmdId_Name(PlayerCompoundMaterialBoostRsp_CmdId value) {
  return ::google::protobuf::internal::NameOfEnum(
    PlayerCompoundMaterialBoostRsp_CmdId_descriptor(), value);
}
inline bool PlayerCompoundMaterialBoostRsp_CmdId_Parse(
    const ::std::string& name, PlayerCompoundMaterialBoostRsp_CmdId* value) {
  return ::google::protobuf::internal::ParseNamedEnum<PlayerCompoundMaterialBoostRsp_CmdId>(
    PlayerCompoundMaterialBoostRsp_CmdId_descriptor(), name, value);
}
enum PlayerGameTimeByLuaNotify_CmdId {
  PlayerGameTimeByLuaNotify_CmdId_NONE = 0,
  PlayerGameTimeByLuaNotify_CmdId_CMD_ID = 178,
  PlayerGameTimeByLuaNotify_CmdId_ENET_CHANNEL_ID = 0,
  PlayerGameTimeByLuaNotify_CmdId_ENET_IS_RELIABLE = 1,
  PlayerGameTimeByLuaNotify_CmdId_PlayerGameTimeByLuaNotify_CmdId_INT_MIN_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32min,
  PlayerGameTimeByLuaNotify_CmdId_PlayerGameTimeByLuaNotify_CmdId_INT_MAX_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32max
};
bool PlayerGameTimeByLuaNotify_CmdId_IsValid(int value);
const PlayerGameTimeByLuaNotify_CmdId PlayerGameTimeByLuaNotify_CmdId_CmdId_MIN = PlayerGameTimeByLuaNotify_CmdId_NONE;
const PlayerGameTimeByLuaNotify_CmdId PlayerGameTimeByLuaNotify_CmdId_CmdId_MAX = PlayerGameTimeByLuaNotify_CmdId_CMD_ID;
const int PlayerGameTimeByLuaNotify_CmdId_CmdId_ARRAYSIZE = PlayerGameTimeByLuaNotify_CmdId_CmdId_MAX + 1;

const ::google::protobuf::EnumDescriptor* PlayerGameTimeByLuaNotify_CmdId_descriptor();
inline const ::std::string& PlayerGameTimeByLuaNotify_CmdId_Name(PlayerGameTimeByLuaNotify_CmdId value) {
  return ::google::protobuf::internal::NameOfEnum(
    PlayerGameTimeByLuaNotify_CmdId_descriptor(), value);
}
inline bool PlayerGameTimeByLuaNotify_CmdId_Parse(
    const ::std::string& name, PlayerGameTimeByLuaNotify_CmdId* value) {
  return ::google::protobuf::internal::ParseNamedEnum<PlayerGameTimeByLuaNotify_CmdId>(
    PlayerGameTimeByLuaNotify_CmdId_descriptor(), name, value);
}
enum PlayerIpRegionNotify_CmdId {
  PlayerIpRegionNotify_CmdId_NONE = 0,
  PlayerIpRegionNotify_CmdId_CMD_ID = 136,
  PlayerIpRegionNotify_CmdId_ENET_CHANNEL_ID = 0,
  PlayerIpRegionNotify_CmdId_ENET_IS_RELIABLE = 1,
  PlayerIpRegionNotify_CmdId_PlayerIpRegionNotify_CmdId_INT_MIN_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32min,
  PlayerIpRegionNotify_CmdId_PlayerIpRegionNotify_CmdId_INT_MAX_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32max
};
bool PlayerIpRegionNotify_CmdId_IsValid(int value);
const PlayerIpRegionNotify_CmdId PlayerIpRegionNotify_CmdId_CmdId_MIN = PlayerIpRegionNotify_CmdId_NONE;
const PlayerIpRegionNotify_CmdId PlayerIpRegionNotify_CmdId_CmdId_MAX = PlayerIpRegionNotify_CmdId_CMD_ID;
const int PlayerIpRegionNotify_CmdId_CmdId_ARRAYSIZE = PlayerIpRegionNotify_CmdId_CmdId_MAX + 1;

const ::google::protobuf::EnumDescriptor* PlayerIpRegionNotify_CmdId_descriptor();
inline const ::std::string& PlayerIpRegionNotify_CmdId_Name(PlayerIpRegionNotify_CmdId value) {
  return ::google::protobuf::internal::NameOfEnum(
    PlayerIpRegionNotify_CmdId_descriptor(), value);
}
inline bool PlayerIpRegionNotify_CmdId_Parse(
    const ::std::string& name, PlayerIpRegionNotify_CmdId* value) {
  return ::google::protobuf::internal::ParseNamedEnum<PlayerIpRegionNotify_CmdId>(
    PlayerIpRegionNotify_CmdId_descriptor(), name, value);
}
...
class AntiAddictNotify : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:proto.AntiAddictNotify) */ {
 public:
  ...
  typedef AntiAddictNotify_CmdId CmdId;
  static const CmdId NONE =
    AntiAddictNotify_CmdId_NONE;
  static const CmdId CMD_ID =
    AntiAddictNotify_CmdId_CMD_ID;
  static const CmdId ENET_CHANNEL_ID =
    AntiAddictNotify_CmdId_ENET_CHANNEL_ID;
  static const CmdId ENET_IS_RELIABLE =
    AntiAddictNotify_CmdId_ENET_IS_RELIABLE;
  static inline bool CmdId_IsValid(int value) {
    return AntiAddictNotify_CmdId_IsValid(value);
  }
  static const CmdId CmdId_MIN =
    AntiAddictNotify_CmdId_CmdId_MIN;
  static const CmdId CmdId_MAX =
    AntiAddictNotify_CmdId_CmdId_MAX;
  static const int CmdId_ARRAYSIZE =
    AntiAddictNotify_CmdId_CmdId_ARRAYSIZE;
  static inline const ::google::protobuf::EnumDescriptor*
  CmdId_descriptor() {
    return AntiAddictNotify_CmdId_descriptor();
  }
  static inline const ::std::string& CmdId_Name(CmdId value) {
    return AntiAddictNotify_CmdId_Name(value);
  }
  static inline bool CmdId_Parse(const ::std::string& name,
      CmdId* value) {
    return AntiAddictNotify_CmdId_Parse(name, value);
  }
...
class PlayerForceExitReq : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:proto.PlayerForceExitReq) */ {
 public:
  ...
  typedef PlayerForceExitReq_CmdId CmdId;
  static const CmdId NONE =
    PlayerForceExitReq_CmdId_NONE;
  static const CmdId CMD_ID =
    PlayerForceExitReq_CmdId_CMD_ID;
  static const CmdId ENET_CHANNEL_ID =
    PlayerForceExitReq_CmdId_ENET_CHANNEL_ID;
  static const CmdId ENET_IS_RELIABLE =
    PlayerForceExitReq_CmdId_ENET_IS_RELIABLE;
  static const CmdId IS_ALLOW_CLIENT =
    PlayerForceExitReq_CmdId_IS_ALLOW_CLIENT;
  static inline bool CmdId_IsValid(int value) {
    return PlayerForceExitReq_CmdId_IsValid(value);
  }
  static const CmdId CmdId_MIN =
    PlayerForceExitReq_CmdId_CmdId_MIN;
  static const CmdId CmdId_MAX =
    PlayerForceExitReq_CmdId_CmdId_MAX;
  static const int CmdId_ARRAYSIZE =
    PlayerForceExitReq_CmdId_CmdId_ARRAYSIZE;
  static inline const ::google::protobuf::EnumDescriptor*
  CmdId_descriptor() {
    return PlayerForceExitReq_CmdId_descriptor();
  }
  static inline const ::std::string& CmdId_Name(CmdId value) {
    return PlayerForceExitReq_CmdId_Name(value);
  }
  static inline bool CmdId_Parse(const ::std::string& name,
      CmdId* value) {
    return PlayerForceExitReq_CmdId_Parse(name, value);
  }
...
class PlayerForceExitRsp : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:proto.PlayerForceExitRsp) */ {
 public:
  ...
  typedef PlayerForceExitRsp_CmdId CmdId;
  static const CmdId NONE =
    PlayerForceExitRsp_CmdId_NONE;
  static const CmdId CMD_ID =
    PlayerForceExitRsp_CmdId_CMD_ID;
  static const CmdId ENET_CHANNEL_ID =
    PlayerForceExitRsp_CmdId_ENET_CHANNEL_ID;
  static const CmdId ENET_IS_RELIABLE =
    PlayerForceExitRsp_CmdId_ENET_IS_RELIABLE;
  static inline bool CmdId_IsValid(int value) {
    return PlayerForceExitRsp_CmdId_IsValid(value);
  }
  static const CmdId CmdId_MIN =
    PlayerForceExitRsp_CmdId_CmdId_MIN;
  static const CmdId CmdId_MAX =
    PlayerForceExitRsp_CmdId_CmdId_MAX;
  static const int CmdId_ARRAYSIZE =
    PlayerForceExitRsp_CmdId_CmdId_ARRAYSIZE;
  static inline const ::google::protobuf::EnumDescriptor*
  CmdId_descriptor() {
    return PlayerForceExitRsp_CmdId_descriptor();
  }
  static inline const ::std::string& CmdId_Name(CmdId value) {
    return PlayerForceExitRsp_CmdId_Name(value);
  }
  static inline bool CmdId_Parse(const ::std::string& name,
      CmdId* value) {
    return PlayerForceExitRsp_CmdId_Parse(name, value);
  }
...
class PlayerInjectFixNotify : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:proto.PlayerInjectFixNotify) */ {
 public:
  ...
  typedef PlayerInjectFixNotify_CmdId CmdId;
  static const CmdId NONE =
    PlayerInjectFixNotify_CmdId_NONE;
  static const CmdId CMD_ID =
    PlayerInjectFixNotify_CmdId_CMD_ID;
  static const CmdId ENET_CHANNEL_ID =
    PlayerInjectFixNotify_CmdId_ENET_CHANNEL_ID;
  static const CmdId ENET_IS_RELIABLE =
    PlayerInjectFixNotify_CmdId_ENET_IS_RELIABLE;
  static inline bool CmdId_IsValid(int value) {
    return PlayerInjectFixNotify_CmdId_IsValid(value);
  }
  static const CmdId CmdId_MIN =
    PlayerInjectFixNotify_CmdId_CmdId_MIN;
  static const CmdId CmdId_MAX =
    PlayerInjectFixNotify_CmdId_CmdId_MAX;
  static const int CmdId_ARRAYSIZE =
    PlayerInjectFixNotify_CmdId_CmdId_ARRAYSIZE;
  static inline const ::google::protobuf::EnumDescriptor*
  CmdId_descriptor() {
    return PlayerInjectFixNotify_CmdId_descriptor();
  }
  static inline const ::std::string& CmdId_Name(CmdId value) {
    return PlayerInjectFixNotify_CmdId_Name(value);
  }
  static inline bool CmdId_Parse(const ::std::string& name,
      CmdId* value) {
    return PlayerInjectFixNotify_CmdId_Parse(name, value);
  }
...
class TaskVarNotify : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:proto.TaskVarNotify) */ {
 public:
  ...
  typedef TaskVarNotify_CmdId CmdId;
  static const CmdId NONE =
    TaskVarNotify_CmdId_NONE;
  static const CmdId CMD_ID =
    TaskVarNotify_CmdId_CMD_ID;
  static const CmdId ENET_CHANNEL_ID =
    TaskVarNotify_CmdId_ENET_CHANNEL_ID;
  static const CmdId ENET_IS_RELIABLE =
    TaskVarNotify_CmdId_ENET_IS_RELIABLE;
  static inline bool CmdId_IsValid(int value) {
    return TaskVarNotify_CmdId_IsValid(value);
  }
  static const CmdId CmdId_MIN =
    TaskVarNotify_CmdId_CmdId_MIN;
  static const CmdId CmdId_MAX =
    TaskVarNotify_CmdId_CmdId_MAX;
  static const int CmdId_ARRAYSIZE =
    TaskVarNotify_CmdId_CmdId_ARRAYSIZE;
  static inline const ::google::protobuf::EnumDescriptor*
  CmdId_descriptor() {
    return TaskVarNotify_CmdId_descriptor();
  }
  static inline const ::std::string& CmdId_Name(CmdId value) {
    return TaskVarNotify_CmdId_Name(value);
  }
  static inline bool CmdId_Parse(const ::std::string& name,
      CmdId* value) {
    return TaskVarNotify_CmdId_Parse(name, value);
  }
...
class ClientLockGameTimeNotify : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:proto.ClientLockGameTimeNotify) */ {
 public:
  ...
  typedef ClientLockGameTimeNotify_CmdId CmdId;
  static const CmdId NONE =
    ClientLockGameTimeNotify_CmdId_NONE;
  static const CmdId CMD_ID =
    ClientLockGameTimeNotify_CmdId_CMD_ID;
  static const CmdId ENET_CHANNEL_ID =
    ClientLockGameTimeNotify_CmdId_ENET_CHANNEL_ID;
  static const CmdId ENET_IS_RELIABLE =
    ClientLockGameTimeNotify_CmdId_ENET_IS_RELIABLE;
  static const CmdId IS_ALLOW_CLIENT =
    ClientLockGameTimeNotify_CmdId_IS_ALLOW_CLIENT;
  static inline bool CmdId_IsValid(int value) {
    return ClientLockGameTimeNotify_CmdId_IsValid(value);
  }
  static const CmdId CmdId_MIN =
    ClientLockGameTimeNotify_CmdId_CmdId_MIN;
  static const CmdId CmdId_MAX =
    ClientLockGameTimeNotify_CmdId_CmdId_MAX;
  static const int CmdId_ARRAYSIZE =
    ClientLockGameTimeNotify_CmdId_CmdId_ARRAYSIZE;
  static inline const ::google::protobuf::EnumDescriptor*
  CmdId_descriptor() {
    return ClientLockGameTimeNotify_CmdId_descriptor();
  }
  static inline const ::std::string& CmdId_Name(CmdId value) {
    return ClientLockGameTimeNotify_CmdId_Name(value);
  }
  static inline bool CmdId_Parse(const ::std::string& name,
      CmdId* value) {
    return ClientLockGameTimeNotify_CmdId_Parse(name, value);
  }
...
class GetNextResourceInfoReq : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:proto.GetNextResourceInfoReq) */ {
 public:
  ...
  typedef GetNextResourceInfoReq_CmdId CmdId;
  static const CmdId NONE =
    GetNextResourceInfoReq_CmdId_NONE;
  static const CmdId CMD_ID =
    GetNextResourceInfoReq_CmdId_CMD_ID;
  static const CmdId ENET_CHANNEL_ID =
    GetNextResourceInfoReq_CmdId_ENET_CHANNEL_ID;
  static const CmdId ENET_IS_RELIABLE =
    GetNextResourceInfoReq_CmdId_ENET_IS_RELIABLE;
  static const CmdId IS_ALLOW_CLIENT =
    GetNextResourceInfoReq_CmdId_IS_ALLOW_CLIENT;
  static inline bool CmdId_IsValid(int value) {
    return GetNextResourceInfoReq_CmdId_IsValid(value);
  }
  static const CmdId CmdId_MIN =
    GetNextResourceInfoReq_CmdId_CmdId_MIN;
  static const CmdId CmdId_MAX =
    GetNextResourceInfoReq_CmdId_CmdId_MAX;
  static const int CmdId_ARRAYSIZE =
    GetNextResourceInfoReq_CmdId_CmdId_ARRAYSIZE;
  static inline const ::google::protobuf::EnumDescriptor*
  CmdId_descriptor() {
    return GetNextResourceInfoReq_CmdId_descriptor();
  }
  static inline const ::std::string& CmdId_Name(CmdId value) {
    return GetNextResourceInfoReq_CmdId_Name(value);
  }
  static inline bool CmdId_Parse(const ::std::string& name,
      CmdId* value) {
    return GetNextResourceInfoReq_CmdId_Parse(name, value);
  }
...
class GetNextResourceInfoRsp : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:proto.GetNextResourceInfoRsp) */ {
 public:
  ...
  typedef GetNextResourceInfoRsp_CmdId CmdId;
  static const CmdId NONE =
    GetNextResourceInfoRsp_CmdId_NONE;
  static const CmdId CMD_ID =
    GetNextResourceInfoRsp_CmdId_CMD_ID;
  static const CmdId ENET_CHANNEL_ID =
    GetNextResourceInfoRsp_CmdId_ENET_CHANNEL_ID;
  static const CmdId ENET_IS_RELIABLE =
    GetNextResourceInfoRsp_CmdId_ENET_IS_RELIABLE;
  static inline bool CmdId_IsValid(int value) {
    return GetNextResourceInfoRsp_CmdId_IsValid(value);
  }
  static const CmdId CmdId_MIN =
    GetNextResourceInfoRsp_CmdId_CmdId_MIN;
  static const CmdId CmdId_MAX =
    GetNextResourceInfoRsp_CmdId_CmdId_MAX;
  static const int CmdId_ARRAYSIZE =
    GetNextResourceInfoRsp_CmdId_CmdId_ARRAYSIZE;
  static inline const ::google::protobuf::EnumDescriptor*
  CmdId_descriptor() {
    return GetNextResourceInfoRsp_CmdId_descriptor();
  }
  static inline const ::std::string& CmdId_Name(CmdId value) {
    return GetNextResourceInfoRsp_CmdId_Name(value);
  }
  static inline bool CmdId_Parse(const ::std::string& name,
      CmdId* value) {
    return GetNextResourceInfoRsp_CmdId_Parse(name, value);
  }
...
class AdjustWorldLevelReq : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:proto.AdjustWorldLevelReq) */ {
 public:
  ...
  typedef AdjustWorldLevelReq_CmdId CmdId;
  static const CmdId NONE =
    AdjustWorldLevelReq_CmdId_NONE;
  static const CmdId CMD_ID =
    AdjustWorldLevelReq_CmdId_CMD_ID;
  static const CmdId ENET_CHANNEL_ID =
    AdjustWorldLevelReq_CmdId_ENET_CHANNEL_ID;
  static const CmdId ENET_IS_RELIABLE =
    AdjustWorldLevelReq_CmdId_ENET_IS_RELIABLE;
  static const CmdId IS_ALLOW_CLIENT =
    AdjustWorldLevelReq_CmdId_IS_ALLOW_CLIENT;
  static inline bool CmdId_IsValid(int value) {
    return AdjustWorldLevelReq_CmdId_IsValid(value);
  }
  static const CmdId CmdId_MIN =
    AdjustWorldLevelReq_CmdId_CmdId_MIN;
  static const CmdId CmdId_MAX =
    AdjustWorldLevelReq_CmdId_CmdId_MAX;
  static const int CmdId_ARRAYSIZE =
    AdjustWorldLevelReq_CmdId_CmdId_ARRAYSIZE;
  static inline const ::google::protobuf::EnumDescriptor*
  CmdId_descriptor() {
    return AdjustWorldLevelReq_CmdId_descriptor();
  }
  static inline const ::std::string& CmdId_Name(CmdId value) {
    return AdjustWorldLevelReq_CmdId_Name(value);
  }
  static inline bool CmdId_Parse(const ::std::string& name,
      CmdId* value) {
    return AdjustWorldLevelReq_CmdId_Parse(name, value);
  }
...
class AdjustWorldLevelRsp : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:proto.AdjustWorldLevelRsp) */ {
 public:
  ...
  typedef AdjustWorldLevelRsp_CmdId CmdId;
  static const CmdId NONE =
    AdjustWorldLevelRsp_CmdId_NONE;
  static const CmdId CMD_ID =
    AdjustWorldLevelRsp_CmdId_CMD_ID;
  static const CmdId ENET_CHANNEL_ID =
    AdjustWorldLevelRsp_CmdId_ENET_CHANNEL_ID;
  static const CmdId ENET_IS_RELIABLE =
    AdjustWorldLevelRsp_CmdId_ENET_IS_RELIABLE;
  static inline bool CmdId_IsValid(int value) {
    return AdjustWorldLevelRsp_CmdId_IsValid(value);
  }
  static const CmdId CmdId_MIN =
    AdjustWorldLevelRsp_CmdId_CmdId_MIN;
  static const CmdId CmdId_MAX =
    AdjustWorldLevelRsp_CmdId_CmdId_MAX;
  static const int CmdId_ARRAYSIZE =
    AdjustWorldLevelRsp_CmdId_CmdId_ARRAYSIZE;
  static inline const ::google::protobuf::EnumDescriptor*
  CmdId_descriptor() {
    return AdjustWorldLevelRsp_CmdId_descriptor();
  }
  static inline const ::std::string& CmdId_Name(CmdId value) {
    return AdjustWorldLevelRsp_CmdId_Name(value);
  }
  static inline bool CmdId_Parse(const ::std::string& name,
      CmdId* value) {
    return AdjustWorldLevelRsp_CmdId_Parse(name, value);
  }
...
class DailyTaskFilterCityReq : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:proto.DailyTaskFilterCityReq) */ {
 public:
  ...
  typedef DailyTaskFilterCityReq_CmdId CmdId;
  static const CmdId NONE =
    DailyTaskFilterCityReq_CmdId_NONE;
  static const CmdId CMD_ID =
    DailyTaskFilterCityReq_CmdId_CMD_ID;
  static const CmdId ENET_CHANNEL_ID =
    DailyTaskFilterCityReq_CmdId_ENET_CHANNEL_ID;
  static const CmdId ENET_IS_RELIABLE =
    DailyTaskFilterCityReq_CmdId_ENET_IS_RELIABLE;
  static const CmdId IS_ALLOW_CLIENT =
    DailyTaskFilterCityReq_CmdId_IS_ALLOW_CLIENT;
  static inline bool CmdId_IsValid(int value) {
    return DailyTaskFilterCityReq_CmdId_IsValid(value);
  }
  static const CmdId CmdId_MIN =
    DailyTaskFilterCityReq_CmdId_CmdId_MIN;
  static const CmdId CmdId_MAX =
    DailyTaskFilterCityReq_CmdId_CmdId_MAX;
  static const int CmdId_ARRAYSIZE =
    DailyTaskFilterCityReq_CmdId_CmdId_ARRAYSIZE;
  static inline const ::google::protobuf::EnumDescriptor*
  CmdId_descriptor() {
    return DailyTaskFilterCityReq_CmdId_descriptor();
  }
  static inline const ::std::string& CmdId_Name(CmdId value) {
    return DailyTaskFilterCityReq_CmdId_Name(value);
  }
  static inline bool CmdId_Parse(const ::std::string& name,
      CmdId* value) {
    return DailyTaskFilterCityReq_CmdId_Parse(name, value);
  }
...
class DailyTaskFilterCityRsp : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:proto.DailyTaskFilterCityRsp) */ {
 public:
  ...
  typedef DailyTaskFilterCityRsp_CmdId CmdId;
  static const CmdId NONE =
    DailyTaskFilterCityRsp_CmdId_NONE;
  static const CmdId CMD_ID =
    DailyTaskFilterCityRsp_CmdId_CMD_ID;
  static const CmdId ENET_CHANNEL_ID =
    DailyTaskFilterCityRsp_CmdId_ENET_CHANNEL_ID;
  static const CmdId ENET_IS_RELIABLE =
    DailyTaskFilterCityRsp_CmdId_ENET_IS_RELIABLE;
  static inline bool CmdId_IsValid(int value) {
    return DailyTaskFilterCityRsp_CmdId_IsValid(value);
  }
  static const CmdId CmdId_MIN =
    DailyTaskFilterCityRsp_CmdId_CmdId_MIN;
  static const CmdId CmdId_MAX =
    DailyTaskFilterCityRsp_CmdId_CmdId_MAX;
  static const int CmdId_ARRAYSIZE =
    DailyTaskFilterCityRsp_CmdId_CmdId_ARRAYSIZE;
  static inline const ::google::protobuf::EnumDescriptor*
  CmdId_descriptor() {
    return DailyTaskFilterCityRsp_CmdId_descriptor();
  }
  static inline const ::std::string& CmdId_Name(CmdId value) {
    return DailyTaskFilterCityRsp_CmdId_Name(value);
  }
  static inline bool CmdId_Parse(const ::std::string& name,
      CmdId* value) {
    return DailyTaskFilterCityRsp_CmdId_Parse(name, value);
  }
...
class DailyTaskUnlockedCitiesNotify : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:proto.DailyTaskUnlockedCitiesNotify) */ {
 public:
  ...
  typedef DailyTaskUnlockedCitiesNotify_CmdId CmdId;
  static const CmdId NONE =
    DailyTaskUnlockedCitiesNotify_CmdId_NONE;
  static const CmdId CMD_ID =
    DailyTaskUnlockedCitiesNotify_CmdId_CMD_ID;
  static const CmdId ENET_CHANNEL_ID =
    DailyTaskUnlockedCitiesNotify_CmdId_ENET_CHANNEL_ID;
  static const CmdId ENET_IS_RELIABLE =
    DailyTaskUnlockedCitiesNotify_CmdId_ENET_IS_RELIABLE;
  static inline bool CmdId_IsValid(int value) {
    return DailyTaskUnlockedCitiesNotify_CmdId_IsValid(value);
  }
  static const CmdId CmdId_MIN =
    DailyTaskUnlockedCitiesNotify_CmdId_CmdId_MIN;
  static const CmdId CmdId_MAX =
    DailyTaskUnlockedCitiesNotify_CmdId_CmdId_MAX;
  static const int CmdId_ARRAYSIZE =
    DailyTaskUnlockedCitiesNotify_CmdId_CmdId_ARRAYSIZE;
  static inline const ::google::protobuf::EnumDescriptor*
  CmdId_descriptor() {
    return DailyTaskUnlockedCitiesNotify_CmdId_descriptor();
  }
  static inline const ::std::string& CmdId_Name(CmdId value) {
    return DailyTaskUnlockedCitiesNotify_CmdId_Name(value);
  }
  static inline bool CmdId_Parse(const ::std::string& name,
      CmdId* value) {
    return DailyTaskUnlockedCitiesNotify_CmdId_Parse(name, value);
  }
...
class ExclusiveRuleNotify : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:proto.ExclusiveRuleNotify) */ {
 public:
  ...
  typedef ExclusiveRuleNotify_CmdId CmdId;
  static const CmdId NONE =
    ExclusiveRuleNotify_CmdId_NONE;
  static const CmdId CMD_ID =
    ExclusiveRuleNotify_CmdId_CMD_ID;
  static const CmdId ENET_CHANNEL_ID =
    ExclusiveRuleNotify_CmdId_ENET_CHANNEL_ID;
  static const CmdId ENET_IS_RELIABLE =
    ExclusiveRuleNotify_CmdId_ENET_IS_RELIABLE;
  static inline bool CmdId_IsValid(int value) {
    return ExclusiveRuleNotify_CmdId_IsValid(value);
  }
  static const CmdId CmdId_MIN =
    ExclusiveRuleNotify_CmdId_CmdId_MIN;
  static const CmdId CmdId_MAX =
    ExclusiveRuleNotify_CmdId_CmdId_MAX;
  static const int CmdId_ARRAYSIZE =
    ExclusiveRuleNotify_CmdId_CmdId_ARRAYSIZE;
  static inline const ::google::protobuf::EnumDescriptor*
  CmdId_descriptor() {
    return ExclusiveRuleNotify_CmdId_descriptor();
  }
  static inline const ::std::string& CmdId_Name(CmdId value) {
    return ExclusiveRuleNotify_CmdId_Name(value);
  }
  static inline bool CmdId_Parse(const ::std::string& name,
      CmdId* value) {
    return ExclusiveRuleNotify_CmdId_Parse(name, value);
  }
...
class CompoundUnlockNotify : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:proto.CompoundUnlockNotify) */ {
 public:
  ...
  typedef CompoundUnlockNotify_CmdId CmdId;
  static const CmdId NONE =
    CompoundUnlockNotify_CmdId_NONE;
  static const CmdId CMD_ID =
    CompoundUnlockNotify_CmdId_CMD_ID;
  static const CmdId ENET_CHANNEL_ID =
    CompoundUnlockNotify_CmdId_ENET_CHANNEL_ID;
  static const CmdId ENET_IS_RELIABLE =
    CompoundUnlockNotify_CmdId_ENET_IS_RELIABLE;
  static inline bool CmdId_IsValid(int value) {
    return CompoundUnlockNotify_CmdId_IsValid(value);
  }
  static const CmdId CmdId_MIN =
    CompoundUnlockNotify_CmdId_CmdId_MIN;
  static const CmdId CmdId_MAX =
    CompoundUnlockNotify_CmdId_CmdId_MAX;
  static const int CmdId_ARRAYSIZE =
    CompoundUnlockNotify_CmdId_CmdId_ARRAYSIZE;
  static inline const ::google::protobuf::EnumDescriptor*
  CmdId_descriptor() {
    return CompoundUnlockNotify_CmdId_descriptor();
  }
  static inline const ::std::string& CmdId_Name(CmdId value) {
    return CompoundUnlockNotify_CmdId_Name(value);
  }
  static inline bool CmdId_Parse(const ::std::string& name,
      CmdId* value) {
    return CompoundUnlockNotify_CmdId_Parse(name, value);
  }
...
class GetGameplayRecommendationReq : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:proto.GetGameplayRecommendationReq) */ {
 public:
  ...
  typedef GetGameplayRecommendationReq_CmdId CmdId;
  static const CmdId NONE =
    GetGameplayRecommendationReq_CmdId_NONE;
  static const CmdId CMD_ID =
    GetGameplayRecommendationReq_CmdId_CMD_ID;
  static const CmdId ENET_CHANNEL_ID =
    GetGameplayRecommendationReq_CmdId_ENET_CHANNEL_ID;
  static const CmdId ENET_IS_RELIABLE =
    GetGameplayRecommendationReq_CmdId_ENET_IS_RELIABLE;
  static const CmdId IS_ALLOW_CLIENT =
    GetGameplayRecommendationReq_CmdId_IS_ALLOW_CLIENT;
  static inline bool CmdId_IsValid(int value) {
    return GetGameplayRecommendationReq_CmdId_IsValid(value);
  }
  static const CmdId CmdId_MIN =
    GetGameplayRecommendationReq_CmdId_CmdId_MIN;
  static const CmdId CmdId_MAX =
    GetGameplayRecommendationReq_CmdId_CmdId_MAX;
  static const int CmdId_ARRAYSIZE =
    GetGameplayRecommendationReq_CmdId_CmdId_ARRAYSIZE;
  static inline const ::google::protobuf::EnumDescriptor*
  CmdId_descriptor() {
    return GetGameplayRecommendationReq_CmdId_descriptor();
  }
  static inline const ::std::string& CmdId_Name(CmdId value) {
    return GetGameplayRecommendationReq_CmdId_Name(value);
  }
  static inline bool CmdId_Parse(const ::std::string& name,
      CmdId* value) {
    return GetGameplayRecommendationReq_CmdId_Parse(name, value);
  }
...
class GetGameplayRecommendationRsp : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:proto.GetGameplayRecommendationRsp) */ {
 public:
  ...
  typedef GetGameplayRecommendationRsp_CmdId CmdId;
  static const CmdId NONE =
    GetGameplayRecommendationRsp_CmdId_NONE;
  static const CmdId CMD_ID =
    GetGameplayRecommendationRsp_CmdId_CMD_ID;
  static const CmdId ENET_CHANNEL_ID =
    GetGameplayRecommendationRsp_CmdId_ENET_CHANNEL_ID;
  static const CmdId ENET_IS_RELIABLE =
    GetGameplayRecommendationRsp_CmdId_ENET_IS_RELIABLE;
  static inline bool CmdId_IsValid(int value) {
    return GetGameplayRecommendationRsp_CmdId_IsValid(value);
  }
  static const CmdId CmdId_MIN =
    GetGameplayRecommendationRsp_CmdId_CmdId_MIN;
  static const CmdId CmdId_MAX =
    GetGameplayRecommendationRsp_CmdId_CmdId_MAX;
  static const int CmdId_ARRAYSIZE =
    GetGameplayRecommendationRsp_CmdId_CmdId_ARRAYSIZE;
  static inline const ::google::protobuf::EnumDescriptor*
  CmdId_descriptor() {
    return GetGameplayRecommendationRsp_CmdId_descriptor();
  }
  static inline const ::std::string& CmdId_Name(CmdId value) {
    return GetGameplayRecommendationRsp_CmdId_Name(value);
  }
  static inline bool CmdId_Parse(const ::std::string& name,
      CmdId* value) {
    return GetGameplayRecommendationRsp_CmdId_Parse(name, value);
  }
...
class TakeBackGivingItemReq : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:proto.TakeBackGivingItemReq) */ {
 public:
  ...
  typedef TakeBackGivingItemReq_CmdId CmdId;
  static const CmdId NONE =
    TakeBackGivingItemReq_CmdId_NONE;
  static const CmdId CMD_ID =
    TakeBackGivingItemReq_CmdId_CMD_ID;
  static const CmdId ENET_CHANNEL_ID =
    TakeBackGivingItemReq_CmdId_ENET_CHANNEL_ID;
  static const CmdId ENET_IS_RELIABLE =
    TakeBackGivingItemReq_CmdId_ENET_IS_RELIABLE;
  static const CmdId IS_ALLOW_CLIENT =
    TakeBackGivingItemReq_CmdId_IS_ALLOW_CLIENT;
  static inline bool CmdId_IsValid(int value) {
    return TakeBackGivingItemReq_CmdId_IsValid(value);
  }
  static const CmdId CmdId_MIN =
    TakeBackGivingItemReq_CmdId_CmdId_MIN;
  static const CmdId CmdId_MAX =
    TakeBackGivingItemReq_CmdId_CmdId_MAX;
  static const int CmdId_ARRAYSIZE =
    TakeBackGivingItemReq_CmdId_CmdId_ARRAYSIZE;
  static inline const ::google::protobuf::EnumDescriptor*
  CmdId_descriptor() {
    return TakeBackGivingItemReq_CmdId_descriptor();
  }
  static inline const ::std::string& CmdId_Name(CmdId value) {
    return TakeBackGivingItemReq_CmdId_Name(value);
  }
  static inline bool CmdId_Parse(const ::std::string& name,
      CmdId* value) {
    return TakeBackGivingItemReq_CmdId_Parse(name, value);
  }
...
class TakeBackGivingItemRsp : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:proto.TakeBackGivingItemRsp) */ {
 public:
  ...
  typedef TakeBackGivingItemRsp_CmdId CmdId;
  static const CmdId NONE =
    TakeBackGivingItemRsp_CmdId_NONE;
  static const CmdId CMD_ID =
    TakeBackGivingItemRsp_CmdId_CMD_ID;
  static const CmdId ENET_CHANNEL_ID =
    TakeBackGivingItemRsp_CmdId_ENET_CHANNEL_ID;
  static const CmdId ENET_IS_RELIABLE =
    TakeBackGivingItemRsp_CmdId_ENET_IS_RELIABLE;
  static inline bool CmdId_IsValid(int value) {
    return TakeBackGivingItemRsp_CmdId_IsValid(value);
  }
  static const CmdId CmdId_MIN =
    TakeBackGivingItemRsp_CmdId_CmdId_MIN;
  static const CmdId CmdId_MAX =
    TakeBackGivingItemRsp_CmdId_CmdId_MAX;
  static const int CmdId_ARRAYSIZE =
    TakeBackGivingItemRsp_CmdId_CmdId_ARRAYSIZE;
  static inline const ::google::protobuf::EnumDescriptor*
  CmdId_descriptor() {
    return TakeBackGivingItemRsp_CmdId_descriptor();
  }
  static inline const ::std::string& CmdId_Name(CmdId value) {
    return TakeBackGivingItemRsp_CmdId_Name(value);
  }
  static inline bool CmdId_Parse(const ::std::string& name,
      CmdId* value) {
    return TakeBackGivingItemRsp_CmdId_Parse(name, value);
  }
...
class PlayerNicknameAuditDataNotify : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:proto.PlayerNicknameAuditDataNotify) */ {
 public:
  ...
  typedef PlayerNicknameAuditDataNotify_CmdId CmdId;
  static const CmdId NONE =
    PlayerNicknameAuditDataNotify_CmdId_NONE;
  static const CmdId CMD_ID =
    PlayerNicknameAuditDataNotify_CmdId_CMD_ID;
  static const CmdId ENET_CHANNEL_ID =
    PlayerNicknameAuditDataNotify_CmdId_ENET_CHANNEL_ID;
  static const CmdId ENET_IS_RELIABLE =
    PlayerNicknameAuditDataNotify_CmdId_ENET_IS_RELIABLE;
  static inline bool CmdId_IsValid(int value) {
    return PlayerNicknameAuditDataNotify_CmdId_IsValid(value);
  }
  static const CmdId CmdId_MIN =
    PlayerNicknameAuditDataNotify_CmdId_CmdId_MIN;
  static const CmdId CmdId_MAX =
    PlayerNicknameAuditDataNotify_CmdId_CmdId_MAX;
  static const int CmdId_ARRAYSIZE =
    PlayerNicknameAuditDataNotify_CmdId_CmdId_ARRAYSIZE;
  static inline const ::google::protobuf::EnumDescriptor*
  CmdId_descriptor() {
    return PlayerNicknameAuditDataNotify_CmdId_descriptor();
  }
  static inline const ::std::string& CmdId_Name(CmdId value) {
    return PlayerNicknameAuditDataNotify_CmdId_Name(value);
  }
  static inline bool CmdId_Parse(const ::std::string& name,
      CmdId* value) {
    return PlayerNicknameAuditDataNotify_CmdId_Parse(name, value);
  }
...
class PlayerNicknameNotify : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:proto.PlayerNicknameNotify) */ {
 public:
  ...
  typedef PlayerNicknameNotify_CmdId CmdId;
  static const CmdId NONE =
    PlayerNicknameNotify_CmdId_NONE;
  static const CmdId CMD_ID =
    PlayerNicknameNotify_CmdId_CMD_ID;
  static const CmdId ENET_CHANNEL_ID =
    PlayerNicknameNotify_CmdId_ENET_CHANNEL_ID;
  static const CmdId ENET_IS_RELIABLE =
    PlayerNicknameNotify_CmdId_ENET_IS_RELIABLE;
  static inline bool CmdId_IsValid(int value) {
    return PlayerNicknameNotify_CmdId_IsValid(value);
  }
  static const CmdId CmdId_MIN =
    PlayerNicknameNotify_CmdId_CmdId_MIN;
  static const CmdId CmdId_MAX =
    PlayerNicknameNotify_CmdId_CmdId_MAX;
  static const int CmdId_ARRAYSIZE =
    PlayerNicknameNotify_CmdId_CmdId_ARRAYSIZE;
  static inline const ::google::protobuf::EnumDescriptor*
  CmdId_descriptor() {
    return PlayerNicknameNotify_CmdId_descriptor();
  }
  static inline const ::std::string& CmdId_Name(CmdId value) {
    return PlayerNicknameNotify_CmdId_Name(value);
  }
  static inline bool CmdId_Parse(const ::std::string& name,
      CmdId* value) {
    return PlayerNicknameNotify_CmdId_Parse(name, value);
  }
...
class NicknameAuditConfigNotify : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:proto.NicknameAuditConfigNotify) */ {
 public:
  ...
  typedef NicknameAuditConfigNotify_CmdId CmdId;
  static const CmdId NONE =
    NicknameAuditConfigNotify_CmdId_NONE;
  static const CmdId CMD_ID =
    NicknameAuditConfigNotify_CmdId_CMD_ID;
  static const CmdId ENET_CHANNEL_ID =
    NicknameAuditConfigNotify_CmdId_ENET_CHANNEL_ID;
  static const CmdId ENET_IS_RELIABLE =
    NicknameAuditConfigNotify_CmdId_ENET_IS_RELIABLE;
  static inline bool CmdId_IsValid(int value) {
    return NicknameAuditConfigNotify_CmdId_IsValid(value);
  }
  static const CmdId CmdId_MIN =
    NicknameAuditConfigNotify_CmdId_CmdId_MIN;
  static const CmdId CmdId_MAX =
    NicknameAuditConfigNotify_CmdId_CmdId_MAX;
  static const int CmdId_ARRAYSIZE =
    NicknameAuditConfigNotify_CmdId_CmdId_ARRAYSIZE;
  static inline const ::google::protobuf::EnumDescriptor*
  CmdId_descriptor() {
    return NicknameAuditConfigNotify_CmdId_descriptor();
  }
  static inline const ::std::string& CmdId_Name(CmdId value) {
    return NicknameAuditConfigNotify_CmdId_Name(value);
  }
  static inline bool CmdId_Parse(const ::std::string& name,
      CmdId* value) {
    return NicknameAuditConfigNotify_CmdId_Parse(name, value);
  }
...
class ReadNicknameAuditReq : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:proto.ReadNicknameAuditReq) */ {
 public:
  ...
  typedef ReadNicknameAuditReq_CmdId CmdId;
  static const CmdId NONE =
    ReadNicknameAuditReq_CmdId_NONE;
  static const CmdId CMD_ID =
    ReadNicknameAuditReq_CmdId_CMD_ID;
  static const CmdId ENET_CHANNEL_ID =
    ReadNicknameAuditReq_CmdId_ENET_CHANNEL_ID;
  static const CmdId ENET_IS_RELIABLE =
    ReadNicknameAuditReq_CmdId_ENET_IS_RELIABLE;
  static const CmdId IS_ALLOW_CLIENT =
    ReadNicknameAuditReq_CmdId_IS_ALLOW_CLIENT;
  static inline bool CmdId_IsValid(int value) {
    return ReadNicknameAuditReq_CmdId_IsValid(value);
  }
  static const CmdId CmdId_MIN =
    ReadNicknameAuditReq_CmdId_CmdId_MIN;
  static const CmdId CmdId_MAX =
    ReadNicknameAuditReq_CmdId_CmdId_MAX;
  static const int CmdId_ARRAYSIZE =
    ReadNicknameAuditReq_CmdId_CmdId_ARRAYSIZE;
  static inline const ::google::protobuf::EnumDescriptor*
  CmdId_descriptor() {
    return ReadNicknameAuditReq_CmdId_descriptor();
  }
  static inline const ::std::string& CmdId_Name(CmdId value) {
    return ReadNicknameAuditReq_CmdId_Name(value);
  }
  static inline bool CmdId_Parse(const ::std::string& name,
      CmdId* value) {
    return ReadNicknameAuditReq_CmdId_Parse(name, value);
  }
...
class ReadNicknameAuditRsp : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:proto.ReadNicknameAuditRsp) */ {
 public:
  ...
  typedef ReadNicknameAuditRsp_CmdId CmdId;
  static const CmdId NONE =
    ReadNicknameAuditRsp_CmdId_NONE;
  static const CmdId CMD_ID =
    ReadNicknameAuditRsp_CmdId_CMD_ID;
  static const CmdId ENET_CHANNEL_ID =
    ReadNicknameAuditRsp_CmdId_ENET_CHANNEL_ID;
  static const CmdId ENET_IS_RELIABLE =
    ReadNicknameAuditRsp_CmdId_ENET_IS_RELIABLE;
  static inline bool CmdId_IsValid(int value) {
    return ReadNicknameAuditRsp_CmdId_IsValid(value);
  }
  static const CmdId CmdId_MIN =
    ReadNicknameAuditRsp_CmdId_CmdId_MIN;
  static const CmdId CmdId_MAX =
    ReadNicknameAuditRsp_CmdId_CmdId_MAX;
  static const int CmdId_ARRAYSIZE =
    ReadNicknameAuditRsp_CmdId_CmdId_ARRAYSIZE;
  static inline const ::google::protobuf::EnumDescriptor*
  CmdId_descriptor() {
    return ReadNicknameAuditRsp_CmdId_descriptor();
  }
  static inline const ::std::string& CmdId_Name(CmdId value) {
    return ReadNicknameAuditRsp_CmdId_Name(value);
  }
  static inline bool CmdId_Parse(const ::std::string& name,
      CmdId* value) {
    return ReadNicknameAuditRsp_CmdId_Parse(name, value);
  }
...
class PlayerCompoundMaterialBoostReq : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:proto.PlayerCompoundMaterialBoostReq) */ {
 public:
  ...
  typedef PlayerCompoundMaterialBoostReq_CmdId CmdId;
  static const CmdId NONE =
    PlayerCompoundMaterialBoostReq_CmdId_NONE;
  static const CmdId CMD_ID =
    PlayerCompoundMaterialBoostReq_CmdId_CMD_ID;
  static const CmdId ENET_CHANNEL_ID =
    PlayerCompoundMaterialBoostReq_CmdId_ENET_CHANNEL_ID;
  static const CmdId ENET_IS_RELIABLE =
    PlayerCompoundMaterialBoostReq_CmdId_ENET_IS_RELIABLE;
  static const CmdId IS_ALLOW_CLIENT =
    PlayerCompoundMaterialBoostReq_CmdId_IS_ALLOW_CLIENT;
  static inline bool CmdId_IsValid(int value) {
    return PlayerCompoundMaterialBoostReq_CmdId_IsValid(value);
  }
  static const CmdId CmdId_MIN =
    PlayerCompoundMaterialBoostReq_CmdId_CmdId_MIN;
  static const CmdId CmdId_MAX =
    PlayerCompoundMaterialBoostReq_CmdId_CmdId_MAX;
  static const int CmdId_ARRAYSIZE =
    PlayerCompoundMaterialBoostReq_CmdId_CmdId_ARRAYSIZE;
  static inline const ::google::protobuf::EnumDescriptor*
  CmdId_descriptor() {
    return PlayerCompoundMaterialBoostReq_CmdId_descriptor();
  }
  static inline const ::std::string& CmdId_Name(CmdId value) {
    return PlayerCompoundMaterialBoostReq_CmdId_Name(value);
  }
  static inline bool CmdId_Parse(const ::std::string& name,
      CmdId* value) {
    return PlayerCompoundMaterialBoostReq_CmdId_Parse(name, value);
  }
...
class PlayerCompoundMaterialBoostRsp : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:proto.PlayerCompoundMaterialBoostRsp) */ {
 public:
  ...
  typedef PlayerCompoundMaterialBoostRsp_CmdId CmdId;
  static const CmdId NONE =
    PlayerCompoundMaterialBoostRsp_CmdId_NONE;
  static const CmdId CMD_ID =
    PlayerCompoundMaterialBoostRsp_CmdId_CMD_ID;
  static const CmdId ENET_CHANNEL_ID =
    PlayerCompoundMaterialBoostRsp_CmdId_ENET_CHANNEL_ID;
  static const CmdId ENET_IS_RELIABLE =
    PlayerCompoundMaterialBoostRsp_CmdId_ENET_IS_RELIABLE;
  static inline bool CmdId_IsValid(int value) {
    return PlayerCompoundMaterialBoostRsp_CmdId_IsValid(value);
  }
  static const CmdId CmdId_MIN =
    PlayerCompoundMaterialBoostRsp_CmdId_CmdId_MIN;
  static const CmdId CmdId_MAX =
    PlayerCompoundMaterialBoostRsp_CmdId_CmdId_MAX;
  static const int CmdId_ARRAYSIZE =
    PlayerCompoundMaterialBoostRsp_CmdId_CmdId_ARRAYSIZE;
  static inline const ::google::protobuf::EnumDescriptor*
  CmdId_descriptor() {
    return PlayerCompoundMaterialBoostRsp_CmdId_descriptor();
  }
  static inline const ::std::string& CmdId_Name(CmdId value) {
    return PlayerCompoundMaterialBoostRsp_CmdId_Name(value);
  }
  static inline bool CmdId_Parse(const ::std::string& name,
      CmdId* value) {
    return PlayerCompoundMaterialBoostRsp_CmdId_Parse(name, value);
  }
...
class PlayerGameTimeByLuaNotify : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:proto.PlayerGameTimeByLuaNotify) */ {
 public:
  ...
  typedef PlayerGameTimeByLuaNotify_CmdId CmdId;
  static const CmdId NONE =
    PlayerGameTimeByLuaNotify_CmdId_NONE;
  static const CmdId CMD_ID =
    PlayerGameTimeByLuaNotify_CmdId_CMD_ID;
  static const CmdId ENET_CHANNEL_ID =
    PlayerGameTimeByLuaNotify_CmdId_ENET_CHANNEL_ID;
  static const CmdId ENET_IS_RELIABLE =
    PlayerGameTimeByLuaNotify_CmdId_ENET_IS_RELIABLE;
  static inline bool CmdId_IsValid(int value) {
    return PlayerGameTimeByLuaNotify_CmdId_IsValid(value);
  }
  static const CmdId CmdId_MIN =
    PlayerGameTimeByLuaNotify_CmdId_CmdId_MIN;
  static const CmdId CmdId_MAX =
    PlayerGameTimeByLuaNotify_CmdId_CmdId_MAX;
  static const int CmdId_ARRAYSIZE =
    PlayerGameTimeByLuaNotify_CmdId_CmdId_ARRAYSIZE;
  static inline const ::google::protobuf::EnumDescriptor*
  CmdId_descriptor() {
    return PlayerGameTimeByLuaNotify_CmdId_descriptor();
  }
  static inline const ::std::string& CmdId_Name(CmdId value) {
    return PlayerGameTimeByLuaNotify_CmdId_Name(value);
  }
  static inline bool CmdId_Parse(const ::std::string& name,
      CmdId* value) {
    return PlayerGameTimeByLuaNotify_CmdId_Parse(name, value);
  }
...
class PlayerIpRegionNotify : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:proto.PlayerIpRegionNotify) */ {
 public:
  ...
  typedef PlayerIpRegionNotify_CmdId CmdId;
  static const CmdId NONE =
    PlayerIpRegionNotify_CmdId_NONE;
  static const CmdId CMD_ID =
    PlayerIpRegionNotify_CmdId_CMD_ID;
  static const CmdId ENET_CHANNEL_ID =
    PlayerIpRegionNotify_CmdId_ENET_CHANNEL_ID;
  static const CmdId ENET_IS_RELIABLE =
    PlayerIpRegionNotify_CmdId_ENET_IS_RELIABLE;
  static inline bool CmdId_IsValid(int value) {
    return PlayerIpRegionNotify_CmdId_IsValid(value);
  }
  static const CmdId CmdId_MIN =
    PlayerIpRegionNotify_CmdId_CmdId_MIN;
  static const CmdId CmdId_MAX =
    PlayerIpRegionNotify_CmdId_CmdId_MAX;
  static const int CmdId_ARRAYSIZE =
    PlayerIpRegionNotify_CmdId_CmdId_ARRAYSIZE;
  static inline const ::google::protobuf::EnumDescriptor*
  CmdId_descriptor() {
    return PlayerIpRegionNotify_CmdId_descriptor();
  }
  static inline const ::std::string& CmdId_Name(CmdId value) {
    return PlayerIpRegionNotify_CmdId_Name(value);
  }
  static inline bool CmdId_Parse(const ::std::string& name,
      CmdId* value) {
    return PlayerIpRegionNotify_CmdId_Parse(name, value);
  }
...
template <> struct is_proto_enum< ::proto::AntiAddictNotify_CmdId> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::proto::AntiAddictNotify_CmdId>() {
  return ::proto::AntiAddictNotify_CmdId_descriptor();
}
template <> struct is_proto_enum< ::proto::PlayerForceExitReq_CmdId> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::proto::PlayerForceExitReq_CmdId>() {
  return ::proto::PlayerForceExitReq_CmdId_descriptor();
}
template <> struct is_proto_enum< ::proto::PlayerForceExitRsp_CmdId> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::proto::PlayerForceExitRsp_CmdId>() {
  return ::proto::PlayerForceExitRsp_CmdId_descriptor();
}
template <> struct is_proto_enum< ::proto::PlayerInjectFixNotify_CmdId> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::proto::PlayerInjectFixNotify_CmdId>() {
  return ::proto::PlayerInjectFixNotify_CmdId_descriptor();
}
template <> struct is_proto_enum< ::proto::TaskVarNotify_CmdId> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::proto::TaskVarNotify_CmdId>() {
  return ::proto::TaskVarNotify_CmdId_descriptor();
}
template <> struct is_proto_enum< ::proto::ClientLockGameTimeNotify_CmdId> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::proto::ClientLockGameTimeNotify_CmdId>() {
  return ::proto::ClientLockGameTimeNotify_CmdId_descriptor();
}
template <> struct is_proto_enum< ::proto::GetNextResourceInfoReq_CmdId> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::proto::GetNextResourceInfoReq_CmdId>() {
  return ::proto::GetNextResourceInfoReq_CmdId_descriptor();
}
template <> struct is_proto_enum< ::proto::GetNextResourceInfoRsp_CmdId> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::proto::GetNextResourceInfoRsp_CmdId>() {
  return ::proto::GetNextResourceInfoRsp_CmdId_descriptor();
}
template <> struct is_proto_enum< ::proto::AdjustWorldLevelReq_CmdId> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::proto::AdjustWorldLevelReq_CmdId>() {
  return ::proto::AdjustWorldLevelReq_CmdId_descriptor();
}
template <> struct is_proto_enum< ::proto::AdjustWorldLevelRsp_CmdId> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::proto::AdjustWorldLevelRsp_CmdId>() {
  return ::proto::AdjustWorldLevelRsp_CmdId_descriptor();
}
template <> struct is_proto_enum< ::proto::DailyTaskFilterCityReq_CmdId> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::proto::DailyTaskFilterCityReq_CmdId>() {
  return ::proto::DailyTaskFilterCityReq_CmdId_descriptor();
}
template <> struct is_proto_enum< ::proto::DailyTaskFilterCityRsp_CmdId> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::proto::DailyTaskFilterCityRsp_CmdId>() {
  return ::proto::DailyTaskFilterCityRsp_CmdId_descriptor();
}
template <> struct is_proto_enum< ::proto::DailyTaskUnlockedCitiesNotify_CmdId> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::proto::DailyTaskUnlockedCitiesNotify_CmdId>() {
  return ::proto::DailyTaskUnlockedCitiesNotify_CmdId_descriptor();
}
template <> struct is_proto_enum< ::proto::ExclusiveRuleNotify_CmdId> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::proto::ExclusiveRuleNotify_CmdId>() {
  return ::proto::ExclusiveRuleNotify_CmdId_descriptor();
}
template <> struct is_proto_enum< ::proto::CompoundUnlockNotify_CmdId> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::proto::CompoundUnlockNotify_CmdId>() {
  return ::proto::CompoundUnlockNotify_CmdId_descriptor();
}
template <> struct is_proto_enum< ::proto::GetGameplayRecommendationReq_CmdId> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::proto::GetGameplayRecommendationReq_CmdId>() {
  return ::proto::GetGameplayRecommendationReq_CmdId_descriptor();
}
template <> struct is_proto_enum< ::proto::GetGameplayRecommendationRsp_CmdId> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::proto::GetGameplayRecommendationRsp_CmdId>() {
  return ::proto::GetGameplayRecommendationRsp_CmdId_descriptor();
}
template <> struct is_proto_enum< ::proto::TakeBackGivingItemReq_CmdId> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::proto::TakeBackGivingItemReq_CmdId>() {
  return ::proto::TakeBackGivingItemReq_CmdId_descriptor();
}
template <> struct is_proto_enum< ::proto::TakeBackGivingItemRsp_CmdId> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::proto::TakeBackGivingItemRsp_CmdId>() {
  return ::proto::TakeBackGivingItemRsp_CmdId_descriptor();
}
template <> struct is_proto_enum< ::proto::PlayerNicknameAuditDataNotify_CmdId> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::proto::PlayerNicknameAuditDataNotify_CmdId>() {
  return ::proto::PlayerNicknameAuditDataNotify_CmdId_descriptor();
}
template <> struct is_proto_enum< ::proto::PlayerNicknameNotify_CmdId> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::proto::PlayerNicknameNotify_CmdId>() {
  return ::proto::PlayerNicknameNotify_CmdId_descriptor();
}
template <> struct is_proto_enum< ::proto::NicknameAuditConfigNotify_CmdId> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::proto::NicknameAuditConfigNotify_CmdId>() {
  return ::proto::NicknameAuditConfigNotify_CmdId_descriptor();
}
template <> struct is_proto_enum< ::proto::ReadNicknameAuditReq_CmdId> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::proto::ReadNicknameAuditReq_CmdId>() {
  return ::proto::ReadNicknameAuditReq_CmdId_descriptor();
}
template <> struct is_proto_enum< ::proto::ReadNicknameAuditRsp_CmdId> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::proto::ReadNicknameAuditRsp_CmdId>() {
  return ::proto::ReadNicknameAuditRsp_CmdId_descriptor();
}
template <> struct is_proto_enum< ::proto::PlayerCompoundMaterialBoostReq_CmdId> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::proto::PlayerCompoundMaterialBoostReq_CmdId>() {
  return ::proto::PlayerCompoundMaterialBoostReq_CmdId_descriptor();
}
template <> struct is_proto_enum< ::proto::PlayerCompoundMaterialBoostRsp_CmdId> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::proto::PlayerCompoundMaterialBoostRsp_CmdId>() {
  return ::proto::PlayerCompoundMaterialBoostRsp_CmdId_descriptor();
}
template <> struct is_proto_enum< ::proto::PlayerGameTimeByLuaNotify_CmdId> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::proto::PlayerGameTimeByLuaNotify_CmdId>() {
  return ::proto::PlayerGameTimeByLuaNotify_CmdId_descriptor();
}
template <> struct is_proto_enum< ::proto::PlayerIpRegionNotify_CmdId> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::proto::PlayerIpRegionNotify_CmdId>() {
  return ::proto::PlayerIpRegionNotify_CmdId_descriptor();
}
